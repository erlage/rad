...
void html_progress_test() {
  group('HTML Progress tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Progress(key: GlobalKey('widget-1'), children: [
            Progress(
              key: GlobalKey('widget-2'),
            ),
            Progress(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<progress id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Progress" '
          'data-${Constants.attrRuntimeType}="$Progress">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Progress"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$Progress"));
