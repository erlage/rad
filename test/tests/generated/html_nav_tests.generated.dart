...
void html_nav_test() {
  group('HTML Navigation tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Navigation(key: GlobalKey('widget-1'), children: [
            Navigation(
              key: GlobalKey('widget-2'),
            ),
            Navigation(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<nav id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Navigation" '
          'data-${Constants.attrRuntimeType}="$Navigation">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Navigation"));
      expect(
          element1.dataset[Constants.attrRuntimeType], equals("$Navigation"));
