...
void html_h5_test() {
  group('HTML Heading5 tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Heading5(key: GlobalKey('widget-1'), children: [
            Heading5(
              key: GlobalKey('widget-2'),
            ),
            Heading5(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<h5 id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Heading5" '
          'data-${Constants.attrRuntimeType}="$Heading5">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Heading5"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$Heading5"));
