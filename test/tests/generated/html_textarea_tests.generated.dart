...
void html_textarea_test() {
  group('HTML TextArea tests:', () {
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$TextArea"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$TextArea"));
