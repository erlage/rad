...
void html_a_test() {
  group('HTML Anchor tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Anchor(key: GlobalKey('widget-1'), children: [
            Anchor(
              key: GlobalKey('widget-2'),
            ),
            Anchor(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<a id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Anchor" '
          'data-${Constants.attrRuntimeType}="$Anchor">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Anchor"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$Anchor"));
