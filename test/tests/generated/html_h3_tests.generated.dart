...
void html_h3_test() {
  group('HTML Heading3 tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Heading3(key: GlobalKey('widget-1'), children: [
            Heading3(
              key: GlobalKey('widget-2'),
            ),
            Heading3(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<h3 id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Heading3" '
          'data-${Constants.attrRuntimeType}="$Heading3">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Heading3"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$Heading3"));
