...
void html_span_test() {
  group('HTML Span tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Span(key: GlobalKey('widget-1'), children: [
            Span(
              key: GlobalKey('widget-2'),
            ),
            Span(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<span id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Span" '
          'data-${Constants.attrRuntimeType}="$Span">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Span"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$Span"));
