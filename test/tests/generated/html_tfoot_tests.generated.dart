  ...
  group('HTML TableFoot tests:', () {
    ...
    test('should set id', () {
      app!.framework.buildChildren(
        widgets: [
          TableFoot(key: Key('some-key'), id: 'some-id'),
          TableFoot(key: LocalKey('some-local-key'), id: 'some-local-id'),
          TableFoot(key: GlobalKey('some-global-key'), id: 'some-global-id'),
        ],
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          TableFoot(id: 'widget-1', children: [
            TableFoot(
              id: 'widget-2',
            ),
            TableFoot(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        equals(
          ...
          //
          (TableFoot).toString() == 'Image' ||
                  (TableFoot).toString() == 'TableColumn'
              ? '<tfoot>'
              : '<tfoot></tfoot>',
        ),
      );
