...
void html_sub_test() {
  group('HTML SubScript tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          SubScript(key: GlobalKey('widget-1'), children: [
            SubScript(
              key: GlobalKey('widget-2'),
            ),
            SubScript(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<sub id="some-global-key" '
          'data-${Constants.attrWidgetType}="$SubScript" '
          'data-${Constants.attrRuntimeType}="$SubScript">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$SubScript"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$SubScript"));
