  ...
  group('HTML Blockquote tests:', () {
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          Blockquote(key: Key('some-key'), id: 'some-id'),
          Blockquote(key: LocalKey('some-local-key'), id: 'some-local-id'),
          Blockquote(key: GlobalKey('some-global-key'), id: 'some-global-id'),
        ],
    ...
    test('should set messy "cite"', () async {
      ...
      expect(
        element1.getAttribute('cite'),
        equals('some cite'),
      );

      expect(
        element2.getAttribute('cite'),
        equals('some "messy" cite'),
      );

      expect(
        element3.getAttribute('cite'),
        equals("some 'messy' cite"),
      );
    });
  });
