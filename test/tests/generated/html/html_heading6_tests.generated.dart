...
void html_heading6_test() {
  group('HTML Heading6 tests:', () {
    RT_AppRunner? app;
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          Heading6(key: Key('some-key'), id: 'some-id'),
          Heading6(key: LocalKey('some-local-key'), id: 'some-local-id'),
          Heading6(key: GlobalKey('some-global-key'), id: 'some-global-id'),
        ],
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          Heading6(key: GlobalKey('el-1'), classAttribute: null),
        ],
        updateType: UpdateType.setState,
        parentContext: app!.appContext,
      );
    ...
    test('should set attribute "hidden" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          Heading6(key: GlobalKey('el-1'), hidden: false),
          Heading6(key: GlobalKey('el-2'), hidden: null),
          Heading6(key: GlobalKey('el-3'), hidden: true),
        ],
        parentContext: app!.appContext,
      );
    ...
    test('should clear attribute "hidden" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          Heading6(key: GlobalKey('el-1'), hidden: true),
          Heading6(key: GlobalKey('el-2'), hidden: true),
          Heading6(key: GlobalKey('el-3'), hidden: true),
          Heading6(key: GlobalKey('el-4'), hidden: true),
        ],
        parentContext: app!.appContext,
      );
      ...
      await app!.updateChildren(
        widgets: [
          Heading6(key: GlobalKey('el-1'), hidden: true),
          Heading6(key: GlobalKey('el-2'), hidden: false),
          Heading6(key: GlobalKey('el-3'), hidden: null),
          Heading6(key: GlobalKey('el-4')),
        ],
        updateType: UpdateType.setState,
        parentContext: app!.appContext,
      );
    ...
    test('should set attribute "onClickAttribute"', () async {
      await app!.buildChildren(
        widgets: [
          Heading6(key: GlobalKey('el-1'), onClickAttribute: 'some-on-click'),
          Heading6(
    ...
    test('should clear attribute "onClickAttribute" if updated value is null',
      ...
      await app!.updateChildren(
        widgets: [
          Heading6(key: GlobalKey('el-1'), onClickAttribute: null),
        ],
        updateType: UpdateType.setState,
        parentContext: app!.appContext,
      );
    ...
    test('should set "click" event listener only if provided', () async {
      ...
      await app!.buildChildren(
        widgets: [
          Heading6(key: GlobalKey('el-1')),
          Heading6(key: GlobalKey('el-2'), onClick: null),
          Heading6(key: GlobalKey('el-3'), onClick: listener),
        ],
        parentContext: app!.appContext,
      );
    ...
    test('should clear "click" event listner', () async {
      ...
      await app!.buildChildren(
        widgets: [
          Heading6(key: GlobalKey('el-1')),
          Heading6(key: GlobalKey('el-2'), onClick: listener),
        ],
        parentContext: app!.appContext,
      );
    ...
    test('should set style', () async {
      await app!.buildChildren(
        widgets: [
          Heading6(key: Key('widget-1'), style: 'some style'),
          Heading6(key: Key('widget-2'), style: 'some "messy" style'),
          Heading6(key: Key('widget-3'), style: "some 'messy' style"),
        ],
        parentContext: RT_TestBed.rootContext,
      );
    ...
    test('should set title', () async {
      await app!.buildChildren(
        widgets: [
          Heading6(key: Key('widget-1'), title: 'some title'),
          Heading6(key: Key('widget-2'), title: 'some "messy" title'),
          Heading6(key: Key('widget-3'), title: "some 'messy' title"),
        ],
        parentContext: RT_TestBed.rootContext,
      );
    ...
    test('should set correct types and markup', () async {
      await app!.buildChildren(
        widgets: [
          Heading6(key: GlobalKey('some-global-key')),
        ],
        parentContext: RT_TestBed.rootContext,
      );
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          Heading6(key: Key('some-key')),
          Heading6(key: LocalKey('some-local-key')),
          Heading6(key: GlobalKey('some-global-key')),
        ],
        parentContext: RT_TestBed.rootContext,
      );
