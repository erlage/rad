  ...
  group('HTML FieldSet tests:', () {
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          FieldSet(key: Key('some-key'), id: 'some-id'),
          FieldSet(key: LocalKey('some-local-key'), id: 'some-local-id'),
          FieldSet(key: GlobalKey('some-global-key'), id: 'some-global-id'),
        ],
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          FieldSet(key: GlobalKey('el-1'), classAttribute: null),
        ],
        updateType: UpdateType.setState,
        parentContext: app!.appContext,
      );
    ...
    test('should set attribute "hidden" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          FieldSet(key: GlobalKey('el-1'), hidden: false),
          FieldSet(key: GlobalKey('el-2'), hidden: null),
          FieldSet(key: GlobalKey('el-3'), hidden: true),
        ],
        parentContext: app!.appContext,
      );
    ...
    test('should clear attribute "hidden" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          FieldSet(key: GlobalKey('el-1'), hidden: true),
          FieldSet(key: GlobalKey('el-2'), hidden: true),
          FieldSet(key: GlobalKey('el-3'), hidden: true),
          FieldSet(key: GlobalKey('el-4'), hidden: true),
        ],
        parentContext: app!.appContext,
      );
      ...
      await app!.updateChildren(
        widgets: [
          FieldSet(key: GlobalKey('el-1'), hidden: true),
          FieldSet(key: GlobalKey('el-2'), hidden: false),
          FieldSet(key: GlobalKey('el-3'), hidden: null),
          FieldSet(key: GlobalKey('el-4')),
        ],
        updateType: UpdateType.setState,
        parentContext: app!.appContext,
      );
    ...
    test('should set attribute "onClickAttribute"', () async {
      await app!.buildChildren(
        widgets: [
          FieldSet(key: GlobalKey('el-1'), onClickAttribute: 'some-on-click'),
          FieldSet(
    ...
    test('should clear attribute "onClickAttribute" if updated value is null',
      ...
      await app!.updateChildren(
        widgets: [
          FieldSet(key: GlobalKey('el-1'), onClickAttribute: null),
        ],
        updateType: UpdateType.setState,
        parentContext: app!.appContext,
      );
    ...
    test('should set "click" event listener only if provided', () async {
      ...
      await app!.buildChildren(
        widgets: [
          FieldSet(key: GlobalKey('el-1')),
          FieldSet(key: GlobalKey('el-2'), onClick: null),
          FieldSet(key: GlobalKey('el-3'), onClick: listener),
        ],
        parentContext: app!.appContext,
      );
    ...
    test('should clear "click" event listner', () async {
      ...
      await app!.buildChildren(
        widgets: [
          FieldSet(key: GlobalKey('el-1')),
          FieldSet(key: GlobalKey('el-2'), onClick: listener),
        ],
        parentContext: app!.appContext,
      );
    ...
    test('should set correct types and markup', () async {
      await app!.buildChildren(
        widgets: [
          FieldSet(key: GlobalKey('some-global-key')),
        ],
        parentContext: RT_TestBed.rootContext,
      );
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          FieldSet(key: Key('some-key')),
          FieldSet(key: LocalKey('some-local-key')),
          FieldSet(key: GlobalKey('some-global-key')),
        ],
        parentContext: RT_TestBed.rootContext,
      );
    ...
    test('should set attribute "disabled" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          FieldSet(key: GlobalKey('el-1'), disabled: false),
          FieldSet(key: GlobalKey('el-2'), disabled: null),
          FieldSet(key: GlobalKey('el-3'), disabled: true),
        ],
        parentContext: app!.appContext,
      );
    ...
    test('should clear attribute "disabled" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          FieldSet(key: GlobalKey('el-1'), disabled: true),
          FieldSet(key: GlobalKey('el-2'), disabled: true),
          FieldSet(key: GlobalKey('el-3'), disabled: true),
          FieldSet(key: GlobalKey('el-4'), disabled: true),
        ],
        parentContext: app!.appContext,
      );
      ...
      await app!.updateChildren(
        widgets: [
          FieldSet(key: GlobalKey('el-1'), disabled: true),
          FieldSet(key: GlobalKey('el-2'), disabled: false),
          FieldSet(key: GlobalKey('el-3'), disabled: null),
          FieldSet(key: GlobalKey('el-4')),
        ],
        updateType: UpdateType.setState,
        parentContext: app!.appContext,
