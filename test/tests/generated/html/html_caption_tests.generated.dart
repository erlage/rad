...
void html_caption_test() {
  group('HTML Caption tests:', () {
    RT_AppRunner? app;
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          Caption(key: Key('some-key'), id: 'some-id'),
          Caption(key: LocalKey('some-local-key'), id: 'some-local-id'),
          Caption(key: GlobalKey('some-global-key'), id: 'some-global-id'),
        ],
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          Caption(key: GlobalKey('el-1'), classAttribute: null),
        ],
        updateType: UpdateType.setState,
        parentContext: app!.appContext,
      );
    ...
    test('should set attribute "hidden" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          Caption(key: GlobalKey('el-1'), hidden: false),
          Caption(key: GlobalKey('el-2'), hidden: null),
          Caption(key: GlobalKey('el-3'), hidden: true),
        ],
        parentContext: app!.appContext,
      );
    ...
    test('should clear attribute "hidden" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          Caption(key: GlobalKey('el-1'), hidden: true),
          Caption(key: GlobalKey('el-2'), hidden: true),
          Caption(key: GlobalKey('el-3'), hidden: true),
          Caption(key: GlobalKey('el-4'), hidden: true),
        ],
        parentContext: app!.appContext,
      );
      ...
      await app!.updateChildren(
        widgets: [
          Caption(key: GlobalKey('el-1'), hidden: true),
          Caption(key: GlobalKey('el-2'), hidden: false),
          Caption(key: GlobalKey('el-3'), hidden: null),
          Caption(key: GlobalKey('el-4')),
        ],
        updateType: UpdateType.setState,
        parentContext: app!.appContext,
      );
    ...
    test('should set attribute "onClickAttribute"', () async {
      await app!.buildChildren(
        widgets: [
          Caption(key: GlobalKey('el-1'), onClickAttribute: 'some-on-click'),
          Caption(key: GlobalKey('el-2'), onClickAttribute: 'another-on-click'),
        ],
        parentContext: app!.appContext,
      );
    ...
    test('should update attribute "onClickAttribute"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          Caption(key: GlobalKey('el-1'), onClickAttribute: 'updated-on-click'),
          Caption(key: GlobalKey('el-2'), onClickAttribute: 'another-on-click'),
        ],
        updateType: UpdateType.setState,
        parentContext: app!.appContext,
    ...
    test('should clear attribute "onClickAttribute" if updated value is null',
      ...
      await app!.updateChildren(
        widgets: [
          Caption(key: GlobalKey('el-1'), onClickAttribute: null),
        ],
        updateType: UpdateType.setState,
        parentContext: app!.appContext,
      );
    ...
    test('should set "click" event listener only if provided', () async {
      ...
      await app!.buildChildren(
        widgets: [
          Caption(key: GlobalKey('el-1')),
          Caption(key: GlobalKey('el-2'), onClick: null),
          Caption(key: GlobalKey('el-3'), onClick: listener),
        ],
        parentContext: app!.appContext,
      );
    ...
    test('should clear "click" event listner', () async {
      ...
      await app!.buildChildren(
        widgets: [
          Caption(key: GlobalKey('el-1')),
          Caption(key: GlobalKey('el-2'), onClick: listener),
        ],
        parentContext: app!.appContext,
      );
    ...
    test('should set style', () async {
      await app!.buildChildren(
        widgets: [
          Caption(key: Key('widget-1'), style: 'some style'),
          Caption(key: Key('widget-2'), style: 'some "messy" style'),
          Caption(key: Key('widget-3'), style: "some 'messy' style"),
        ],
        parentContext: RT_TestBed.rootContext,
      );
    ...
    test('should set title', () async {
      await app!.buildChildren(
        widgets: [
          Caption(key: Key('widget-1'), title: 'some title'),
          Caption(key: Key('widget-2'), title: 'some "messy" title'),
          Caption(key: Key('widget-3'), title: "some 'messy' title"),
        ],
        parentContext: RT_TestBed.rootContext,
      );
    ...
    test('should set correct types and markup', () async {
      await app!.buildChildren(
        widgets: [
          Caption(key: GlobalKey('some-global-key')),
        ],
        parentContext: RT_TestBed.rootContext,
      );
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          Caption(key: Key('some-key')),
          Caption(key: LocalKey('some-local-key')),
          Caption(key: GlobalKey('some-global-key')),
        ],
        parentContext: RT_TestBed.rootContext,
      );
