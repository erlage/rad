...
void html_table_body_test() {
  group('HTML TableBody tests:', () {
    RT_AppRunner? app;
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          TableBody(key: Key('some-key'), id: 'some-id'),
          TableBody(key: LocalKey('some-local-key'), id: 'some-local-id'),
          TableBody(key: GlobalKey('some-global-key'), id: 'some-global-id'),
        ],
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          TableBody(key: GlobalKey('el-1'), classAttribute: null),
        ],
        updateType: UpdateType.setState,
        parentContext: app!.appContext,
      );
    ...
    test('should set attribute "hidden" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          TableBody(key: GlobalKey('el-1'), hidden: false),
          TableBody(key: GlobalKey('el-2'), hidden: null),
          TableBody(key: GlobalKey('el-3'), hidden: true),
        ],
        parentContext: app!.appContext,
      );
    ...
    test('should clear attribute "hidden" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          TableBody(key: GlobalKey('el-1'), hidden: true),
          TableBody(key: GlobalKey('el-2'), hidden: true),
          TableBody(key: GlobalKey('el-3'), hidden: true),
          TableBody(key: GlobalKey('el-4'), hidden: true),
        ],
        parentContext: app!.appContext,
      );
      ...
      await app!.updateChildren(
        widgets: [
          TableBody(key: GlobalKey('el-1'), hidden: true),
          TableBody(key: GlobalKey('el-2'), hidden: false),
          TableBody(key: GlobalKey('el-3'), hidden: null),
          TableBody(key: GlobalKey('el-4')),
        ],
        updateType: UpdateType.setState,
        parentContext: app!.appContext,
      );
    ...
    test('should set attribute "onClickAttribute"', () async {
      await app!.buildChildren(
        widgets: [
          TableBody(key: GlobalKey('el-1'), onClickAttribute: 'some-on-click'),
          TableBody(
    ...
    test('should clear attribute "onClickAttribute" if updated value is null',
      ...
      await app!.updateChildren(
        widgets: [
          TableBody(key: GlobalKey('el-1'), onClickAttribute: null),
        ],
        updateType: UpdateType.setState,
        parentContext: app!.appContext,
      );
    ...
    test('should set "click" event listener only if provided', () async {
      ...
      await app!.buildChildren(
        widgets: [
          TableBody(key: GlobalKey('el-1')),
          TableBody(key: GlobalKey('el-2'), onClick: null),
          TableBody(key: GlobalKey('el-3'), onClick: listener),
        ],
        parentContext: app!.appContext,
      );
    ...
    test('should clear "click" event listner', () async {
      ...
      await app!.buildChildren(
        widgets: [
          TableBody(key: GlobalKey('el-1')),
          TableBody(key: GlobalKey('el-2'), onClick: listener),
        ],
        parentContext: app!.appContext,
      );
    ...
    test('should set style', () async {
      await app!.buildChildren(
        widgets: [
          TableBody(key: Key('widget-1'), style: 'some style'),
          TableBody(key: Key('widget-2'), style: 'some "messy" style'),
          TableBody(key: Key('widget-3'), style: "some 'messy' style"),
        ],
        parentContext: RT_TestBed.rootContext,
      );
    ...
    test('should set title', () async {
      await app!.buildChildren(
        widgets: [
          TableBody(key: Key('widget-1'), title: 'some title'),
          TableBody(key: Key('widget-2'), title: 'some "messy" title'),
          TableBody(key: Key('widget-3'), title: "some 'messy' title"),
        ],
        parentContext: RT_TestBed.rootContext,
      );
    ...
    test('should set correct types and markup', () async {
      await app!.buildChildren(
        widgets: [
          TableBody(key: GlobalKey('some-global-key')),
        ],
        parentContext: RT_TestBed.rootContext,
      );
    ...
    test('should have a short-tag alias', () async {
      var widget = TableBody();
      var widgetShort = tbody();
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          TableBody(key: Key('some-key')),
          TableBody(key: LocalKey('some-local-key')),
          TableBody(key: GlobalKey('some-global-key')),
        ],
        parentContext: RT_TestBed.rootContext,
      );
