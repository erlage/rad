...
void html_th_test() {
  group('HTML TableHeaderCell tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          TableHeaderCell(key: GlobalKey('widget-1'), children: [
            TableHeaderCell(
              key: GlobalKey('widget-2'),
            ),
            TableHeaderCell(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<th id="some-global-key" '
          'data-${Constants.attrWidgetType}="$TableHeaderCell" '
          'data-${Constants.attrRuntimeType}="$TableHeaderCell">',
