...
void html_canvas_test() {
  group('HTML Canvas tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Canvas(key: GlobalKey('widget-1'), children: [
            Canvas(
              key: GlobalKey('widget-2'),
            ),
            Canvas(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<canvas id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Canvas" '
          'data-${Constants.attrRuntimeType}="$Canvas">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Canvas"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$Canvas"));
