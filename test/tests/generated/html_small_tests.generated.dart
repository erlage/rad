...
void html_small_test() {
  group('HTML Small tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Small(key: GlobalKey('widget-1'), children: [
            Small(
              key: GlobalKey('widget-2'),
            ),
            Small(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<small id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Small" '
          'data-${Constants.attrRuntimeType}="$Small">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Small"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$Small"));
