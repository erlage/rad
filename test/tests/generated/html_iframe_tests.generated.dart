...
void html_iframe_test() {
  group('HTML IFrame tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          IFrame(key: GlobalKey('widget-1'), children: [
            IFrame(
              key: GlobalKey('widget-2'),
            ),
            IFrame(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<iframe id="some-global-key" '
          'data-${Constants.attrWidgetType}="$IFrame" '
          'data-${Constants.attrRuntimeType}="$IFrame">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$IFrame"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$IFrame"));
