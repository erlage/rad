...
void html_h1_test() {
  group('HTML Heading1 tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Heading1(key: GlobalKey('widget-1'), children: [
            Heading1(
              key: GlobalKey('widget-2'),
            ),
            Heading1(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<h1 id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Heading1" '
          'data-${Constants.attrRuntimeType}="$Heading1">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Heading1"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$Heading1"));
