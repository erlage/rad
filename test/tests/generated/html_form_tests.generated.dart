...
void html_form_test() {
  group('HTML Form tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Form(key: GlobalKey('widget-1'), children: [
            Form(
              key: GlobalKey('widget-2'),
            ),
            Form(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<form id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Form" '
          'data-${Constants.attrRuntimeType}="$Form">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Form"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$Form"));
