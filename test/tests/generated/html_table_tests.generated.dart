  ...
  group('HTML Table tests:', () {
    ...
    test('should set id', () {
      app!.framework.buildChildren(
        widgets: [
          Table(key: Key('some-key'), id: 'some-id'),
          Table(key: LocalKey('some-local-key'), id: 'some-local-id'),
          Table(key: GlobalKey('some-global-key'), id: 'some-global-id'),
        ],
