...
void html_h2_test() {
  group('HTML Heading2 tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Heading2(key: GlobalKey('widget-1'), children: [
            Heading2(
              key: GlobalKey('widget-2'),
            ),
            Heading2(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<h2 id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Heading2" '
          'data-${Constants.attrRuntimeType}="$Heading2">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Heading2"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$Heading2"));
