...
void html_strong_test() {
  group('HTML Strong tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Strong(key: GlobalKey('widget-1'), children: [
            Strong(
              key: GlobalKey('widget-2'),
            ),
            Strong(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<strong id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Strong" '
          'data-${Constants.attrRuntimeType}="$Strong">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Strong"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$Strong"));
