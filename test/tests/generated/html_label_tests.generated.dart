...
void html_label_test() {
  group('HTML Label tests:', () {
    ...
    test('should update attribute "for"', () {
      app!.framework.buildChildren(
        widgets: [
          Label(key: GlobalKey('el-1'), forAttribute: 'some-for'),
          Label(key: GlobalKey('el-2'), forAttribute: 'another-for'),
    ...
    test('should clear attribute "for"', () {
      app!.framework.buildChildren(
        widgets: [
          Label(key: GlobalKey('el-1')),
          Label(key: GlobalKey('el-2'), forAttribute: 'another-for'),
    ...
    test('should clear attribute "for" if updated value is null', () {
      app!.framework.buildChildren(
        widgets: [
          Label(key: GlobalKey('el-1'), forAttribute: 'some-for'),
        ],
    ...
    test('should not set attribute "for" if provided value is null', () {
      app!.framework.buildChildren(
        widgets: [
          Label(key: GlobalKey('el-1'), forAttribute: null),
        ],
