...
void html_label_test() {
  group('HTML Label tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Label(key: GlobalKey('widget-1'), children: [
            Label(
              key: GlobalKey('widget-2'),
            ),
            Label(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<label id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Label" '
          'data-${Constants.attrRuntimeType}="$Label">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Label"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$Label"));
