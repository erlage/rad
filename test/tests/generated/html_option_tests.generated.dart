...
void html_option_test() {
  group('HTML Option tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Option(key: GlobalKey('widget-1'), children: [
            Option(
              key: GlobalKey('widget-2'),
            ),
            Option(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<option id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Option" '
          'data-${Constants.attrRuntimeType}="$Option">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Option"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$Option"));
