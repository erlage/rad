...
void html_td_test() {
  group('HTML TableDataCell tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          TableDataCell(key: GlobalKey('widget-1'), children: [
            TableDataCell(
              key: GlobalKey('widget-2'),
            ),
            TableDataCell(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<td id="some-global-key" '
          'data-${Constants.attrWidgetType}="$TableDataCell" '
          'data-${Constants.attrRuntimeType}="$TableDataCell">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(
          element1.dataset[Constants.attrWidgetType], equals("$TableDataCell"));
      expect(element1.dataset[Constants.attrRuntimeType],
          equals("$TableDataCell"));
