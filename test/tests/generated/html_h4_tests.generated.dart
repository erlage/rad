...
void html_h4_test() {
  group('HTML Heading4 tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Heading4(key: GlobalKey('widget-1'), children: [
            Heading4(
              key: GlobalKey('widget-2'),
            ),
            Heading4(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<h4 id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Heading4" '
          'data-${Constants.attrRuntimeType}="$Heading4">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Heading4"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$Heading4"));
