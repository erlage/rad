...
void html_h6_test() {
  group('HTML Heading6 tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Heading6(key: GlobalKey('widget-1'), children: [
            Heading6(
              key: GlobalKey('widget-2'),
            ),
            Heading6(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<h6 id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Heading6" '
          'data-${Constants.attrRuntimeType}="$Heading6">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Heading6"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$Heading6"));
