...
void html_p_test() {
  group('HTML Paragraph tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Paragraph(key: GlobalKey('widget-1'), children: [
            Paragraph(
              key: GlobalKey('widget-2'),
            ),
            Paragraph(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<p id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Paragraph" '
          'data-${Constants.attrRuntimeType}="$Paragraph">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Paragraph"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$Paragraph"));
