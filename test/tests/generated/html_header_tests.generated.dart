...
void html_header_test() {
  group('HTML Header tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Header(key: GlobalKey('widget-1'), children: [
            Header(
              key: GlobalKey('widget-2'),
            ),
            Header(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<header id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Header" '
          'data-${Constants.attrRuntimeType}="$Header">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Header"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$Header"));
