...
void html_caption_test() {
  group('HTML Caption tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Caption(key: GlobalKey('widget-1'), children: [
            Caption(
              key: GlobalKey('widget-2'),
            ),
            Caption(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<caption id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Caption" '
          'data-${Constants.attrRuntimeType}="$Caption">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Caption"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$Caption"));
