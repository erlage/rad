...
void html_sup_test() {
  group('HTML SuperScript tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          SuperScript(key: GlobalKey('widget-1'), children: [
            SuperScript(
              key: GlobalKey('widget-2'),
            ),
            SuperScript(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<sup id="some-global-key" '
          'data-${Constants.attrWidgetType}="$SuperScript" '
          'data-${Constants.attrRuntimeType}="$SuperScript">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(
          element1.dataset[Constants.attrWidgetType], equals("$SuperScript"));
      expect(
          element1.dataset[Constants.attrRuntimeType], equals("$SuperScript"));
