...
void html_colgroup_test() {
  group('HTML TableColumnGroup tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          TableColumnGroup(key: GlobalKey('widget-1'), children: [
            TableColumnGroup(
              key: GlobalKey('widget-2'),
            ),
            TableColumnGroup(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<colgroup id="some-global-key" '
          'data-${Constants.attrWidgetType}="$TableColumnGroup" '
          'data-${Constants.attrRuntimeType}="$TableColumnGroup">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType],
          equals("$TableColumnGroup"));
      expect(element1.dataset[Constants.attrRuntimeType],
          equals("$TableColumnGroup"));
