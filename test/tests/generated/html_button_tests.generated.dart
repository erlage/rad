...
void html_button_test() {
  group('HTML Button tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Button(key: GlobalKey('widget-1'), children: [
            Button(
              key: GlobalKey('widget-2'),
            ),
            Button(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<button id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Button" '
          'data-${Constants.attrRuntimeType}="$Button">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Button"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$Button"));
