...
void html_blockquote_test() {
  group('HTML Blockquote tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Blockquote(key: GlobalKey('widget-1'), children: [
            Blockquote(
              key: GlobalKey('widget-2'),
            ),
            Blockquote(
    ...
    test('should set correct types and markup', () {
      app!.framework.buildChildren(
        widgets: [
          Blockquote(key: GlobalKey('some-global-key')),
        ],
        parentContext: RT_TestBed.rootContext,
      );
      ...
      expect(
        ...
        startsWith(
          '<blockquote id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Blockquote" '
          'data-${Constants.attrRuntimeType}="$Blockquote">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Blockquote"));
      expect(
          element1.dataset[Constants.attrRuntimeType], equals("$Blockquote"));
    ...
    test('should set key', () {
      app!.framework.buildChildren(
        widgets: [
          Blockquote(key: Key('some-key')),
          Blockquote(key: LocalKey('some-local-key')),
          Blockquote(key: GlobalKey('some-global-key')),
        ],
        parentContext: RT_TestBed.rootContext,
      );
