...
void html_footer_test() {
  group('HTML Footer tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Footer(key: GlobalKey('widget-1'), children: [
            Footer(
              key: GlobalKey('widget-2'),
            ),
            Footer(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<footer id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Footer" '
          'data-${Constants.attrRuntimeType}="$Footer">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Footer"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$Footer"));
