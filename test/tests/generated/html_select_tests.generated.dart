...
void html_select_test() {
  group('HTML Select tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          Select(key: GlobalKey('widget-1'), children: [
            Select(
              key: GlobalKey('widget-2'),
            ),
            Select(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<select id="some-global-key" '
          'data-${Constants.attrWidgetType}="$Select" '
          'data-${Constants.attrRuntimeType}="$Select">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$Select"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$Select"));
