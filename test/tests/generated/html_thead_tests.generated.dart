...
void html_thead_test() {
  group('HTML TableHead tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          TableHead(key: GlobalKey('widget-1'), children: [
            TableHead(
              key: GlobalKey('widget-2'),
            ),
            TableHead(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<thead id="some-global-key" '
          'data-${Constants.attrWidgetType}="$TableHead" '
          'data-${Constants.attrRuntimeType}="$TableHead">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$TableHead"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$TableHead"));
