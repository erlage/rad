...
void html_tr_test() {
  group('HTML TableRow tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          TableRow(key: GlobalKey('widget-1'), children: [
            TableRow(
              key: GlobalKey('widget-2'),
            ),
            TableRow(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<tr id="some-global-key" '
          'data-${Constants.attrWidgetType}="$TableRow" '
          'data-${Constants.attrRuntimeType}="$TableRow">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$TableRow"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$TableRow"));
