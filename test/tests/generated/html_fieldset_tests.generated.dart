...
void html_fieldset_test() {
  group('HTML FieldSet tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          FieldSet(key: GlobalKey('widget-1'), children: [
            FieldSet(
              key: GlobalKey('widget-2'),
            ),
            FieldSet(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<fieldset id="some-global-key" '
          'data-${Constants.attrWidgetType}="$FieldSet" '
          'data-${Constants.attrRuntimeType}="$FieldSet">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$FieldSet"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$FieldSet"));
