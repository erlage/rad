...
void html_li_test() {
  group('HTML ListItem tests:', () {
    ...
    test('should set children widgets', () {
      app!.framework.buildChildren(
        widgets: [
          ListItem(key: GlobalKey('widget-1'), children: [
            ListItem(
              key: GlobalKey('widget-2'),
            ),
            ListItem(
    ...
    test('should set correct types and markup', () {
      ...
      expect(
        ...
        startsWith(
          '<li id="some-global-key" '
          'data-${Constants.attrWidgetType}="$ListItem" '
          'data-${Constants.attrRuntimeType}="$ListItem">',
    ...
    test('should not override system reserved data attributes on build', () {
      ...
      expect(element1.dataset[Constants.attrWidgetType], equals("$ListItem"));
      expect(element1.dataset[Constants.attrRuntimeType], equals("$ListItem"));
