...
// Path: packages/flutter/test/widgets/async_test.dart
// -----------------------------------------------------------------------
//
...
//    - Turn on skip for the test "requiring data preserves the stackTrace"
//
// -----------------------------------------------------------------------
// -----------------------------------------------------------------------
...
void main() {
  ...
  group('FutureBuilder', () {
    ...
    testWidgets('debugRethrowError rethrows caught error',
        (WidgetTester tester) async {
  ...
  group(
    ...
    testWidgets('when completing with error and with stack trace',
        (WidgetTester tester) async {
      final Completer<String> completer = Completer<String>();
      await tester.pumpWidget(Column(children: <Widget>[
        FutureBuilder<String>(future: completer.future, builder: snapshotText),
