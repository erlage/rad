...
void html_deleted_text_test() {
  group('HTML DeletedText tests:', () {
    RT_AppRunner? app;
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          DeletedText(key: Key('some-key-1'), id: 'some-id-1'),
          DeletedText(key: Key('some-key-2'), id: 'some-id-2'),
          DeletedText(key: Key('some-key-3'), id: 'some-id-3'),
        ],
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          DeletedText(key: Key('el-1'), className: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "hidden" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          DeletedText(key: Key('el-1'), hidden: false),
          DeletedText(key: Key('el-2'), hidden: null),
          DeletedText(key: Key('el-3'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "hidden" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          DeletedText(key: Key('el-1'), hidden: true),
          DeletedText(key: Key('el-2'), hidden: true),
          DeletedText(key: Key('el-3'), hidden: true),
          DeletedText(key: Key('el-4'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          DeletedText(key: Key('el-1'), hidden: true),
          DeletedText(key: Key('el-2'), hidden: false),
          DeletedText(key: Key('el-3'), hidden: null),
          DeletedText(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set "click" event listener only if provided', () async {
      ...
      await app!.buildChildren(
        widgets: [
          DeletedText(key: Key('el-1')),
          DeletedText(key: Key('el-2'), onClick: null),
          DeletedText(key: Key('el-3'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear "click" event listener', () async {
      ...
      await app!.buildChildren(
        widgets: [
          DeletedText(key: Key('el-1')),
          DeletedText(key: Key('el-2'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set style', () async {
      await app!.buildChildren(
        widgets: [
          DeletedText(key: Key('widget-1'), style: 'some style'),
          DeletedText(key: Key('widget-2'), style: 'some "messy" style'),
          DeletedText(key: Key('widget-3'), style: "some 'messy' style"),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set title', () async {
      await app!.buildChildren(
        widgets: [
          DeletedText(key: Key('widget-1'), title: 'some title'),
          DeletedText(key: Key('widget-2'), title: 'some "messy" title'),
          DeletedText(key: Key('widget-3'), title: "some 'messy' title"),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should call ref with correct element', () async {
      ...
      await app!.buildChildren(
        widgets: [
          DeletedText(id: 'some-id-1', ref: (el) => el1 = el),
          DeletedText(id: 'some-id-2', ref: (el) => el2 = el),
          DeletedText(id: 'some-id-3', ref: (el) => el3 = el),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set correct types and markup', () async {
      await app!.buildChildren(
        widgets: [
          DeletedText(key: Key('some-key-3')),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          DeletedText(key: Key('some-key-1')),
          DeletedText(key: Key('some-key-2')),
          DeletedText(key: Key('some-key-3')),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "cite"', () async {
      await app!.buildChildren(
        widgets: [
          DeletedText(key: Key('el-1'), cite: 'some-cite'),
          DeletedText(key: Key('el-2'), cite: 'another-cite'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "cite"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          DeletedText(key: Key('el-1'), cite: 'updated-cite'),
          DeletedText(key: Key('el-2'), cite: 'another-cite'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should clear attribute "cite" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          DeletedText(key: Key('el-1'), cite: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "datetime"', () async {
      await app!.buildChildren(
        widgets: [
          DeletedText(key: Key('el-1'), dateTime: 'some-value'),
          DeletedText(key: Key('el-2'), dateTime: 'another-value'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "datetime"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          DeletedText(key: Key('el-1'), dateTime: 'updated-value'),
          DeletedText(key: Key('el-2'), dateTime: 'another-value'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should clear attribute "datetime" if updated value is null',
      ...
      await app!.updateChildren(
        widgets: [
          DeletedText(key: Key('el-1'), dateTime: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
