  ...
  group('HTML Abbreviation tests:', () {
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          Abbreviation(key: GlobalKey('some-key-1'), id: 'some-id-1'),
          Abbreviation(key: GlobalKey('some-key-2'), id: 'some-id-2'),
          Abbreviation(key: GlobalKey('some-key-3'), id: 'some-id-3'),
        ],
    ...
    test('should clear attribute "classes"', () async {
      await app!.buildChildren(
        widgets: [
          Abbreviation(key: GlobalKey('el-1')),
          Abbreviation(
            key: GlobalKey('el-2'),
            classAttribute: 'another-classes',
          ),
      ...
      await app!.updateChildren(
        widgets: [
          Abbreviation(key: GlobalKey('el-1')),
          Abbreviation(key: GlobalKey('el-2')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          Abbreviation(key: GlobalKey('el-1'), classAttribute: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "hidden" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          Abbreviation(key: GlobalKey('el-1'), hidden: false),
          Abbreviation(key: GlobalKey('el-2'), hidden: null),
          Abbreviation(key: GlobalKey('el-3'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "hidden" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          Abbreviation(key: GlobalKey('el-1'), hidden: true),
          Abbreviation(key: GlobalKey('el-2'), hidden: true),
          Abbreviation(key: GlobalKey('el-3'), hidden: true),
          Abbreviation(key: GlobalKey('el-4'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          Abbreviation(key: GlobalKey('el-1'), hidden: true),
          Abbreviation(key: GlobalKey('el-2'), hidden: false),
          Abbreviation(key: GlobalKey('el-3'), hidden: null),
          Abbreviation(key: GlobalKey('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "onClickAttribute" if updated value is null',
      ...
      await app!.updateChildren(
        widgets: [
          Abbreviation(key: GlobalKey('el-1'), onClickAttribute: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set "click" event listener only if provided', () async {
      ...
      await app!.buildChildren(
        widgets: [
          Abbreviation(key: GlobalKey('el-1')),
          Abbreviation(key: GlobalKey('el-2'), onClick: null),
          Abbreviation(key: GlobalKey('el-3'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear "click" event listner', () async {
      ...
      await app!.buildChildren(
        widgets: [
          Abbreviation(key: GlobalKey('el-1')),
          Abbreviation(key: GlobalKey('el-2'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set correct types and markup', () async {
      await app!.buildChildren(
        widgets: [
          Abbreviation(key: GlobalKey('some-key-3')),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          Abbreviation(key: GlobalKey('some-key-1')),
          Abbreviation(key: GlobalKey('some-key-2')),
          Abbreviation(key: GlobalKey('some-key-3')),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
