  ...
  group('HTML Code tests:', () {
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          Code(key: GlobalKey('some-key-1'), id: 'some-id-1'),
          Code(key: GlobalKey('some-key-2'), id: 'some-id-2'),
          Code(key: GlobalKey('some-key-3'), id: 'some-id-3'),
        ],
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          Code(key: GlobalKey('some-key-1')),
          Code(key: GlobalKey('some-key-2')),
          Code(key: GlobalKey('some-key-3')),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
