...
void html_audio_test() {
  group('HTML Audio tests:', () {
    RT_AppRunner? app;
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          Audio(key: Key('some-key-1'), id: 'some-id-1'),
          Audio(key: Key('some-key-2'), id: 'some-id-2'),
          Audio(key: Key('some-key-3'), id: 'some-id-3'),
        ],
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          Audio(key: Key('el-1'), className: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "hidden" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          Audio(key: Key('el-1'), hidden: false),
          Audio(key: Key('el-2'), hidden: null),
          Audio(key: Key('el-3'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "hidden" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          Audio(key: Key('el-1'), hidden: true),
          Audio(key: Key('el-2'), hidden: true),
          Audio(key: Key('el-3'), hidden: true),
          Audio(key: Key('el-4'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          Audio(key: Key('el-1'), hidden: true),
          Audio(key: Key('el-2'), hidden: false),
          Audio(key: Key('el-3'), hidden: null),
          Audio(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should set "click" event listener only if provided', () async {
      ...
      await app!.buildChildren(
        widgets: [
          Audio(key: Key('el-1')),
          Audio(key: Key('el-2'), onClick: null),
          Audio(key: Key('el-3'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear "click" event listener', () async {
      ...
      await app!.buildChildren(
        widgets: [
          Audio(key: Key('el-1')),
          Audio(key: Key('el-2'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set style', () async {
      await app!.buildChildren(
        widgets: [
          Audio(key: Key('widget-1'), style: 'some style'),
          Audio(key: Key('widget-2'), style: 'some "messy" style'),
          Audio(key: Key('widget-3'), style: "some 'messy' style"),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set title', () async {
      await app!.buildChildren(
        widgets: [
          Audio(key: Key('widget-1'), title: 'some title'),
          Audio(key: Key('widget-2'), title: 'some "messy" title'),
          Audio(key: Key('widget-3'), title: "some 'messy' title"),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should call ref with correct element', () async {
      ...
      await app!.buildChildren(
        widgets: [
          Audio(id: 'some-id-1', ref: (el) => el1 = el),
          Audio(id: 'some-id-2', ref: (el) => el2 = el),
          Audio(id: 'some-id-3', ref: (el) => el3 = el),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          Audio(key: Key('some-key-1')),
          Audio(key: Key('some-key-2')),
          Audio(key: Key('some-key-3')),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "autoplay" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          Audio(key: Key('el-1'), autoPlay: false),
          Audio(key: Key('el-2'), autoPlay: null),
          Audio(key: Key('el-3'), autoPlay: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "autoplay" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          Audio(key: Key('el-1'), autoPlay: true),
          Audio(key: Key('el-2'), autoPlay: true),
          Audio(key: Key('el-3'), autoPlay: true),
          Audio(key: Key('el-4'), autoPlay: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          Audio(key: Key('el-1'), autoPlay: true),
          Audio(key: Key('el-2'), autoPlay: false),
          Audio(key: Key('el-3'), autoPlay: null),
          Audio(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should set attribute "controls" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          Audio(key: Key('el-1'), controls: false),
          Audio(key: Key('el-2'), controls: null),
          Audio(key: Key('el-3'), controls: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "controls" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          Audio(key: Key('el-1'), controls: true),
          Audio(key: Key('el-2'), controls: true),
          Audio(key: Key('el-3'), controls: true),
          Audio(key: Key('el-4'), controls: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          Audio(key: Key('el-1'), controls: true),
          Audio(key: Key('el-2'), controls: false),
          Audio(key: Key('el-3'), controls: null),
          Audio(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should set attribute "loop" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          Audio(key: Key('el-1'), loop: false),
          Audio(key: Key('el-2'), loop: null),
          Audio(key: Key('el-3'), loop: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "loop" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          Audio(key: Key('el-1'), loop: true),
          Audio(key: Key('el-2'), loop: true),
          Audio(key: Key('el-3'), loop: true),
          Audio(key: Key('el-4'), loop: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          Audio(key: Key('el-1'), loop: true),
          Audio(key: Key('el-2'), loop: false),
          Audio(key: Key('el-3'), loop: null),
          Audio(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should set attribute "muted" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          Audio(key: Key('el-1'), muted: false),
          Audio(key: Key('el-2'), muted: null),
          Audio(key: Key('el-3'), muted: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "muted" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          Audio(key: Key('el-1'), muted: true),
          Audio(key: Key('el-2'), muted: true),
          Audio(key: Key('el-3'), muted: true),
          Audio(key: Key('el-4'), muted: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          Audio(key: Key('el-1'), muted: true),
          Audio(key: Key('el-2'), muted: false),
          Audio(key: Key('el-3'), muted: null),
          Audio(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should set attribute "src"', () async {
      await app!.buildChildren(
        widgets: [
          Audio(key: Key('el-1'), src: 'some-src'),
          Audio(key: Key('el-2'), src: 'another-src'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "src"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          Audio(key: Key('el-1'), src: 'updated-src'),
          Audio(key: Key('el-2'), src: 'another-src'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
