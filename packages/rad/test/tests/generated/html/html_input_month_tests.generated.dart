...
void html_input_month_test() {
  group('HTML InputMonth tests:', () {
    ...
    test('should call ref with correct element', () async {
      ...
      await app!.buildChildren(
        widgets: [
          InputMonth(id: 'some-id-1', ref: (el) => el1 = el),
          InputMonth(id: 'some-id-2', ref: (el) => el2 = el),
          InputMonth(id: 'some-id-3', ref: (el) => el3 = el),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set property "value"', () async {
      await app!.buildChildren(
        widgets: [
          InputMonth(key: Key('el-1'), value: '2022-07'),
          InputMonth(key: Key('el-2'), value: '2022-08'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update property "value"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputMonth(key: Key('el-1'), value: '2022-02'),
          InputMonth(key: Key('el-2'), value: '2022-08'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
