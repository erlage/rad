  ...
  group('HTML TableBody tests:', () {
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          TableBody(key: Key('some-key-1'), id: 'some-id-1'),
          TableBody(key: Key('some-key-2'), id: 'some-id-2'),
          TableBody(key: Key('some-key-3'), id: 'some-id-3'),
        ],
    ...
    test('should set attribute "hidden" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          TableBody(key: Key('el-1'), hidden: false),
          TableBody(key: Key('el-2'), hidden: null),
          TableBody(key: Key('el-3'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "hidden" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          TableBody(key: Key('el-1'), hidden: true),
          TableBody(key: Key('el-2'), hidden: true),
          TableBody(key: Key('el-3'), hidden: true),
          TableBody(key: Key('el-4'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          TableBody(key: Key('el-1'), hidden: true),
          TableBody(key: Key('el-2'), hidden: false),
          TableBody(key: Key('el-3'), hidden: null),
          TableBody(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "onClickAttribute"', () async {
      await app!.buildChildren(
        widgets: [
          TableBody(key: Key('el-1'), onClickAttribute: 'some-on-click'),
          TableBody(key: Key('el-2'), onClickAttribute: 'another-on-click'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "onClickAttribute"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          TableBody(key: Key('el-1'), onClickAttribute: 'updated-on-click'),
          TableBody(key: Key('el-2'), onClickAttribute: 'another-on-click'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should clear attribute "onClickAttribute" if updated value is null',
      ...
      await app!.updateChildren(
        widgets: [
          TableBody(key: Key('el-1'), onClickAttribute: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set "click" event listener only if provided', () async {
      ...
      await app!.buildChildren(
        widgets: [
          TableBody(key: Key('el-1')),
          TableBody(key: Key('el-2'), onClick: null),
          TableBody(key: Key('el-3'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear "click" event listner', () async {
      ...
      await app!.buildChildren(
        widgets: [
          TableBody(key: Key('el-1')),
          TableBody(key: Key('el-2'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          TableBody(key: Key('some-key-1')),
          TableBody(key: Key('some-key-2')),
          TableBody(key: Key('some-key-3')),
        ],
        parentRenderElement: app!.appRenderElement,
      );
