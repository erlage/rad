...
void html_option_group_test() {
  group('HTML OptionGroup tests:', () {
    RT_AppRunner? app;
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          OptionGroup(key: Key('some-key-1'), id: 'some-id-1'),
          OptionGroup(key: Key('some-key-2'), id: 'some-id-2'),
          OptionGroup(key: Key('some-key-3'), id: 'some-id-3'),
        ],
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          OptionGroup(key: Key('el-1'), className: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "hidden" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          OptionGroup(key: Key('el-1'), hidden: false),
          OptionGroup(key: Key('el-2'), hidden: null),
          OptionGroup(key: Key('el-3'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "hidden" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          OptionGroup(key: Key('el-1'), hidden: true),
          OptionGroup(key: Key('el-2'), hidden: true),
          OptionGroup(key: Key('el-3'), hidden: true),
          OptionGroup(key: Key('el-4'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          OptionGroup(key: Key('el-1'), hidden: true),
          OptionGroup(key: Key('el-2'), hidden: false),
          OptionGroup(key: Key('el-3'), hidden: null),
          OptionGroup(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set "click" event listener only if provided', () async {
      ...
      await app!.buildChildren(
        widgets: [
          OptionGroup(key: Key('el-1')),
          OptionGroup(key: Key('el-2'), onClick: null),
          OptionGroup(key: Key('el-3'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear "click" event listener', () async {
      ...
      await app!.buildChildren(
        widgets: [
          OptionGroup(key: Key('el-1')),
          OptionGroup(key: Key('el-2'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set style', () async {
      await app!.buildChildren(
        widgets: [
          OptionGroup(key: Key('widget-1'), style: 'some style'),
          OptionGroup(key: Key('widget-2'), style: 'some "messy" style'),
          OptionGroup(key: Key('widget-3'), style: "some 'messy' style"),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set title', () async {
      await app!.buildChildren(
        widgets: [
          OptionGroup(key: Key('widget-1'), title: 'some title'),
          OptionGroup(key: Key('widget-2'), title: 'some "messy" title'),
          OptionGroup(key: Key('widget-3'), title: "some 'messy' title"),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should call ref with correct element', () async {
      ...
      await app!.buildChildren(
        widgets: [
          OptionGroup(id: 'some-id-1', ref: (el) => el1 = el),
          OptionGroup(id: 'some-id-2', ref: (el) => el2 = el),
          OptionGroup(id: 'some-id-3', ref: (el) => el3 = el),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set correct types and markup', () async {
      await app!.buildChildren(
        widgets: [
          OptionGroup(key: Key('some-key-3')),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should have a short-tag alias', () async {
      var widget = OptionGroup();
      var widgetShort = optgroup();
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          OptionGroup(key: Key('some-key-1')),
          OptionGroup(key: Key('some-key-2')),
          OptionGroup(key: Key('some-key-3')),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "label"', () async {
      await app!.buildChildren(
        widgets: [
          OptionGroup(key: Key('el-1'), label: 'some-label'),
          OptionGroup(key: Key('el-2'), label: 'another-label'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "label"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          OptionGroup(key: Key('el-1'), label: 'updated-label'),
          OptionGroup(key: Key('el-2'), label: 'another-label'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should clear attribute "label" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          OptionGroup(key: Key('el-1'), label: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "disabled" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          OptionGroup(key: Key('el-1'), disabled: false),
          OptionGroup(key: Key('el-2'), disabled: null),
          OptionGroup(key: Key('el-3'), disabled: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "disabled" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          OptionGroup(key: Key('el-1'), disabled: true),
          OptionGroup(key: Key('el-2'), disabled: true),
          OptionGroup(key: Key('el-3'), disabled: true),
          OptionGroup(key: Key('el-4'), disabled: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          OptionGroup(key: Key('el-1'), disabled: true),
          OptionGroup(key: Key('el-2'), disabled: false),
          OptionGroup(key: Key('el-3'), disabled: null),
          OptionGroup(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
