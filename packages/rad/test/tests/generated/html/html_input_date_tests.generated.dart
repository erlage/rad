...
void html_input_date_test() {
  group('HTML InputDate tests:', () {
    RT_AppRunner? app;
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('some-key-1'), id: 'some-id-1'),
          InputDate(key: Key('some-key-2'), id: 'some-id-2'),
          InputDate(key: Key('some-key-3'), id: 'some-id-3'),
        ],
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), className: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "hidden" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('el-1'), hidden: false),
          InputDate(key: Key('el-2'), hidden: null),
          InputDate(key: Key('el-3'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "hidden" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('el-1'), hidden: true),
          InputDate(key: Key('el-2'), hidden: true),
          InputDate(key: Key('el-3'), hidden: true),
          InputDate(key: Key('el-4'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), hidden: true),
          InputDate(key: Key('el-2'), hidden: false),
          InputDate(key: Key('el-3'), hidden: null),
          InputDate(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set "click" event listener only if provided', () async {
      ...
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('el-1')),
          InputDate(key: Key('el-2'), onClick: null),
          InputDate(key: Key('el-3'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear "click" event listener', () async {
      ...
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('el-1')),
          InputDate(key: Key('el-2'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set style', () async {
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('widget-1'), style: 'some style'),
          InputDate(key: Key('widget-2'), style: 'some "messy" style'),
          InputDate(key: Key('widget-3'), style: "some 'messy' style"),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
    ...
    test('should set title', () async {
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('widget-1'), title: 'some title'),
          InputDate(key: Key('widget-2'), title: 'some "messy" title'),
          InputDate(key: Key('widget-3'), title: "some 'messy' title"),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
    ...
    test('should call ref with correct element', () async {
      ...
      await app!.buildChildren(
        widgets: [
          InputDate(id: 'some-id-1', ref: (el) => el1 = el),
          InputDate(id: 'some-id-2', ref: (el) => el2 = el),
          InputDate(id: 'some-id-3', ref: (el) => el3 = el),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('some-key-1')),
          InputDate(key: Key('some-key-2')),
          InputDate(key: Key('some-key-3')),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "autocomplete"', () async {
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('el-1'), autoComplete: 'some-autocomplete'),
          InputDate(key: Key('el-2'), autoComplete: 'another-autocomplete'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "autocomplete"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), autoComplete: 'updated-autocomplete'),
          InputDate(key: Key('el-2'), autoComplete: 'another-autocomplete'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test(
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), autoComplete: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "list"', () async {
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('el-1'), list: 'some-list'),
          InputDate(key: Key('el-2'), list: 'another-list'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "list"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), list: 'updated-list'),
          InputDate(key: Key('el-2'), list: 'another-list'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should clear attribute "list" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), list: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "max"', () async {
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('el-1'), max: 'some-max'),
          InputDate(key: Key('el-2'), max: 'another-max'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "max"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), max: 'updated-max'),
          InputDate(key: Key('el-2'), max: 'another-max'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should clear attribute "max" if updated max is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), max: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "min"', () async {
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('el-1'), min: 'some-min'),
          InputDate(key: Key('el-2'), min: 'another-min'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "min"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), min: 'updated-min'),
          InputDate(key: Key('el-2'), min: 'another-min'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should clear attribute "min" if updated min is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), min: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "readonly" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('el-1'), readOnly: false),
          InputDate(key: Key('el-2'), readOnly: null),
          InputDate(key: Key('el-3'), readOnly: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "readonly" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('el-1'), readOnly: true),
          InputDate(key: Key('el-2'), readOnly: true),
          InputDate(key: Key('el-3'), readOnly: true),
          InputDate(key: Key('el-4'), readOnly: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), readOnly: true),
          InputDate(key: Key('el-2'), readOnly: false),
          InputDate(key: Key('el-3'), readOnly: null),
          InputDate(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should set attribute "required" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('el-1'), required: false),
          InputDate(key: Key('el-2'), required: null),
          InputDate(key: Key('el-3'), required: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "required" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('el-1'), required: true),
          InputDate(key: Key('el-2'), required: true),
          InputDate(key: Key('el-3'), required: true),
          InputDate(key: Key('el-4'), required: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), required: true),
          InputDate(key: Key('el-2'), required: false),
          InputDate(key: Key('el-3'), required: null),
          InputDate(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should set attribute "step"', () async {
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('el-1'), step: 'some-step'),
          InputDate(key: Key('el-2'), step: 'another-step'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "step"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), step: 'updated-step'),
          InputDate(key: Key('el-2'), step: 'another-step'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should clear attribute "step" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), step: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "name"', () async {
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('el-1'), name: 'some-name'),
          InputDate(key: Key('el-2'), name: 'another-name'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "name"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), name: 'updated-name'),
          InputDate(key: Key('el-2'), name: 'another-name'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should clear attribute "name" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), name: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "disabled" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('el-1'), disabled: false),
          InputDate(key: Key('el-2'), disabled: null),
          InputDate(key: Key('el-3'), disabled: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "disabled" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('el-1'), disabled: true),
          InputDate(key: Key('el-2'), disabled: true),
          InputDate(key: Key('el-3'), disabled: true),
          InputDate(key: Key('el-4'), disabled: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), disabled: true),
          InputDate(key: Key('el-2'), disabled: false),
          InputDate(key: Key('el-3'), disabled: null),
          InputDate(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should set attribute "form"', () async {
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('el-1'), form: 'some-form'),
          InputDate(key: Key('el-2'), form: 'another-form'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "form"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), form: 'updated-form'),
          InputDate(key: Key('el-2'), form: 'another-form'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should clear attribute "form" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), form: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "inputmode"', () async {
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('el-1'), inputMode: 'some-inputmode'),
          InputDate(key: Key('el-2'), inputMode: 'another-inputmode'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "inputmode"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), inputMode: 'updated-inputmode'),
          InputDate(key: Key('el-2'), inputMode: 'another-inputmode'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should clear attribute "inputmode" if updated value is null',
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), inputMode: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set property "value"', () async {
      await app!.buildChildren(
        widgets: [
          InputDate(key: Key('el-1'), value: '2022-07-13'),
          InputDate(key: Key('el-2'), value: '2022-07-10'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      expect((domNode1 as InputElement).value, equals('2022-07-13'));
      expect((domNode2 as InputElement).value, equals('2022-07-10'));
    });
    ...
    test('should update property "value"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), value: '2022-07-08'),
          InputDate(key: Key('el-2'), value: '2022-07-10'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      ...
      expect((domNode1 as InputElement).value, equals('2022-07-08'));
      expect((domNode2 as InputElement).value, equals('2022-07-10'));
    });
    ...
    test('should clear property "value" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputDate(key: Key('el-1'), value: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
