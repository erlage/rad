...
void html_table_column_group_test() {
  group('HTML TableColumnGroup tests:', () {
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          TableColumnGroup(key: Key('el-1'), className: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should call ref with correct element', () async {
      ...
      await app!.buildChildren(
        widgets: [
          TableColumnGroup(id: 'some-id-1', ref: (el) => el1 = el),
          TableColumnGroup(id: 'some-id-2', ref: (el) => el2 = el),
          TableColumnGroup(id: 'some-id-3', ref: (el) => el3 = el),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should have a short-tag alias', () async {
      var widget = TableColumnGroup();
      var widgetShort = colgroup();
