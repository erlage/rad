...
void html_portal_test() {
  group('HTML Portal tests:', () {
    ...
    test('should call ref with correct element', () async {
      ...
      await app!.buildChildren(
        widgets: [
          Portal(id: 'some-id-1', ref: (el) => el1 = el),
          Portal(id: 'some-id-2', ref: (el) => el2 = el),
          Portal(id: 'some-id-3', ref: (el) => el3 = el),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "referrerpolicy"', () async {
      await app!.buildChildren(
        widgets: [
          ...
          Portal(key: Key('el-3'), referrerPolicy: ReferrerPolicyType.origin),
          Portal(
              key: Key('el-4'),
    ...
    test('should update attribute "referrerpolicy"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          Portal(key: Key('el-1')),
          Portal(key: Key('el-2'), referrerPolicy: null),
          Portal(
              key: Key('el-3'),
              referrerPolicy: ReferrerPolicyType.originWhenCrossOrigin),
        ],
