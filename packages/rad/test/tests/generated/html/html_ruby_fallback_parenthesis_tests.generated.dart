...
void html_ruby_fallback_parenthesis_test() {
  group('HTML RubyFallbackParenthesis tests:', () {
    RT_AppRunner? app;
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          RubyFallbackParenthesis(key: Key('some-key-1'), id: 'some-id-1'),
          RubyFallbackParenthesis(key: Key('some-key-2'), id: 'some-id-2'),
          RubyFallbackParenthesis(key: Key('some-key-3'), id: 'some-id-3'),
        ],
    ...
    test('should clear attribute "classes"', () async {
      await app!.buildChildren(
        widgets: [
          RubyFallbackParenthesis(key: Key('el-1')),
          RubyFallbackParenthesis(
            key: Key('el-2'),
            className: 'another-classes',
          ),
      ...
      await app!.updateChildren(
        widgets: [
          RubyFallbackParenthesis(key: Key('el-1')),
          RubyFallbackParenthesis(key: Key('el-2')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          RubyFallbackParenthesis(key: Key('el-1'), className: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "hidden" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          RubyFallbackParenthesis(key: Key('el-1'), hidden: false),
          RubyFallbackParenthesis(key: Key('el-2'), hidden: null),
          RubyFallbackParenthesis(key: Key('el-3'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "hidden" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          RubyFallbackParenthesis(key: Key('el-1'), hidden: true),
          RubyFallbackParenthesis(key: Key('el-2'), hidden: true),
          RubyFallbackParenthesis(key: Key('el-3'), hidden: true),
          RubyFallbackParenthesis(key: Key('el-4'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          RubyFallbackParenthesis(key: Key('el-1'), hidden: true),
          RubyFallbackParenthesis(key: Key('el-2'), hidden: false),
          RubyFallbackParenthesis(key: Key('el-3'), hidden: null),
          RubyFallbackParenthesis(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set "click" event listener only if provided', () async {
      ...
      await app!.buildChildren(
        widgets: [
          RubyFallbackParenthesis(key: Key('el-1')),
          RubyFallbackParenthesis(key: Key('el-2'), onClick: null),
          RubyFallbackParenthesis(key: Key('el-3'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear "click" event listener', () async {
      ...
      await app!.buildChildren(
        widgets: [
          RubyFallbackParenthesis(key: Key('el-1')),
          RubyFallbackParenthesis(key: Key('el-2'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set style', () async {
      await app!.buildChildren(
        widgets: [
          RubyFallbackParenthesis(key: Key('widget-1'), style: 'some style'),
          RubyFallbackParenthesis(
    ...
    test('should set title', () async {
      await app!.buildChildren(
        widgets: [
          RubyFallbackParenthesis(key: Key('widget-1'), title: 'some title'),
          RubyFallbackParenthesis(
    ...
    test('should call ref with correct element', () async {
      ...
      await app!.buildChildren(
        widgets: [
          RubyFallbackParenthesis(id: 'some-id-1', ref: (el) => el1 = el),
          RubyFallbackParenthesis(id: 'some-id-2', ref: (el) => el2 = el),
          RubyFallbackParenthesis(id: 'some-id-3', ref: (el) => el3 = el),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should call ref-callback with null on dispose', () async {
      ...
      await app!.updateChildren(
        widgets: [RubyFallbackParenthesis()],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should not call ref-callback on update', () async {
      ...
      await app!.buildChildren(
        widgets: [
          RubyFallbackParenthesis(ref: (el) {
            stack.push('callback');
          }),
        ],
        parentRenderElement: app!.appRenderElement,
    ...
    test('should set correct types and markup', () async {
      await app!.buildChildren(
        widgets: [
          RubyFallbackParenthesis(key: Key('some-key-3')),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
    ...
    test('should have a short-tag alias', () async {
      var widget = RubyFallbackParenthesis();
      var widgetShort = rp();
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          RubyFallbackParenthesis(key: Key('some-key-1')),
          RubyFallbackParenthesis(key: Key('some-key-2')),
          RubyFallbackParenthesis(key: Key('some-key-3')),
        ],
        parentRenderElement: app!.appRenderElement,
      );
