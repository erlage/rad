...
void html_dialog_test() {
  group('HTML Dialog tests:', () {
    RT_AppRunner? app;
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          Dialog(key: Key('some-key-1'), id: 'some-id-1'),
          Dialog(key: Key('some-key-2'), id: 'some-id-2'),
          Dialog(key: Key('some-key-3'), id: 'some-id-3'),
        ],
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          Dialog(key: Key('el-1'), className: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "hidden" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          Dialog(key: Key('el-1'), hidden: false),
          Dialog(key: Key('el-2'), hidden: null),
          Dialog(key: Key('el-3'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "hidden" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          Dialog(key: Key('el-1'), hidden: true),
          Dialog(key: Key('el-2'), hidden: true),
          Dialog(key: Key('el-3'), hidden: true),
          Dialog(key: Key('el-4'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          Dialog(key: Key('el-1'), hidden: true),
          Dialog(key: Key('el-2'), hidden: false),
          Dialog(key: Key('el-3'), hidden: null),
          Dialog(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should set "click" event listener only if provided', () async {
      ...
      await app!.buildChildren(
        widgets: [
          Dialog(key: Key('el-1')),
          Dialog(key: Key('el-2'), onClick: null),
          Dialog(key: Key('el-3'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear "click" event listener', () async {
      ...
      await app!.buildChildren(
        widgets: [
          Dialog(key: Key('el-1')),
          Dialog(key: Key('el-2'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set style', () async {
      await app!.buildChildren(
        widgets: [
          Dialog(key: Key('widget-1'), style: 'some style'),
          Dialog(key: Key('widget-2'), style: 'some "messy" style'),
          Dialog(key: Key('widget-3'), style: "some 'messy' style"),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set title', () async {
      await app!.buildChildren(
        widgets: [
          Dialog(key: Key('widget-1'), title: 'some title'),
          Dialog(key: Key('widget-2'), title: 'some "messy" title'),
          Dialog(key: Key('widget-3'), title: "some 'messy' title"),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should call ref with correct element', () async {
      ...
      await app!.buildChildren(
        widgets: [
          Dialog(id: 'some-id-1', ref: (el) => el1 = el),
          Dialog(id: 'some-id-2', ref: (el) => el2 = el),
          Dialog(id: 'some-id-3', ref: (el) => el3 = el),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          Dialog(key: Key('some-key-1')),
          Dialog(key: Key('some-key-2')),
          Dialog(key: Key('some-key-3')),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "open" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          Dialog(key: Key('el-1'), open: false),
          Dialog(key: Key('el-2'), open: null),
          Dialog(key: Key('el-3'), open: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "open" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          Dialog(key: Key('el-1'), open: true),
          Dialog(key: Key('el-2'), open: true),
          Dialog(key: Key('el-3'), open: true),
          Dialog(key: Key('el-4'), open: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          Dialog(key: Key('el-1'), open: true),
          Dialog(key: Key('el-2'), open: false),
          Dialog(key: Key('el-3'), open: null),
          Dialog(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
