...
void html_preformatted_text_test() {
  group('HTML PreformattedText tests:', () {
    RT_AppRunner? app;
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          PreformattedText(key: Key('some-key-1'), id: 'some-id-1'),
          PreformattedText(key: Key('some-key-2'), id: 'some-id-2'),
          PreformattedText(key: Key('some-key-3'), id: 'some-id-3'),
        ],
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          PreformattedText(key: Key('el-1'), className: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "hidden" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          PreformattedText(key: Key('el-1'), hidden: false),
          PreformattedText(key: Key('el-2'), hidden: null),
          PreformattedText(key: Key('el-3'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "hidden" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          PreformattedText(key: Key('el-1'), hidden: true),
          PreformattedText(key: Key('el-2'), hidden: true),
          PreformattedText(key: Key('el-3'), hidden: true),
          PreformattedText(key: Key('el-4'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          PreformattedText(key: Key('el-1'), hidden: true),
          PreformattedText(key: Key('el-2'), hidden: false),
          PreformattedText(key: Key('el-3'), hidden: null),
          PreformattedText(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set "click" event listener only if provided', () async {
      ...
      await app!.buildChildren(
        widgets: [
          PreformattedText(key: Key('el-1')),
          PreformattedText(key: Key('el-2'), onClick: null),
          PreformattedText(key: Key('el-3'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear "click" event listener', () async {
      ...
      await app!.buildChildren(
        widgets: [
          PreformattedText(key: Key('el-1')),
          PreformattedText(key: Key('el-2'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set style', () async {
      await app!.buildChildren(
        widgets: [
          PreformattedText(key: Key('widget-1'), style: 'some style'),
          PreformattedText(key: Key('widget-2'), style: 'some "messy" style'),
          PreformattedText(key: Key('widget-3'), style: "some 'messy' style"),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set title', () async {
      await app!.buildChildren(
        widgets: [
          PreformattedText(key: Key('widget-1'), title: 'some title'),
          PreformattedText(key: Key('widget-2'), title: 'some "messy" title'),
          PreformattedText(key: Key('widget-3'), title: "some 'messy' title"),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should call ref with correct element', () async {
      ...
      await app!.buildChildren(
        widgets: [
          PreformattedText(id: 'some-id-1', ref: (el) => el1 = el),
          PreformattedText(id: 'some-id-2', ref: (el) => el2 = el),
          PreformattedText(id: 'some-id-3', ref: (el) => el3 = el),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set correct types and markup', () async {
      await app!.buildChildren(
        widgets: [
          PreformattedText(key: Key('some-key-3')),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          PreformattedText(key: Key('some-key-1')),
          PreformattedText(key: Key('some-key-2')),
          PreformattedText(key: Key('some-key-3')),
        ],
        parentRenderElement: app!.appRenderElement,
      );
