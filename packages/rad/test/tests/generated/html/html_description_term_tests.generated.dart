...
void html_description_term_test() {
  group('HTML DescriptionTerm tests:', () {
    RT_AppRunner? app;
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          DescriptionTerm(key: Key('some-key-1'), id: 'some-id-1'),
          DescriptionTerm(key: Key('some-key-2'), id: 'some-id-2'),
          DescriptionTerm(key: Key('some-key-3'), id: 'some-id-3'),
        ],
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          DescriptionTerm(key: Key('el-1'), className: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "hidden" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          DescriptionTerm(key: Key('el-1'), hidden: false),
          DescriptionTerm(key: Key('el-2'), hidden: null),
          DescriptionTerm(key: Key('el-3'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "hidden" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          DescriptionTerm(key: Key('el-1'), hidden: true),
          DescriptionTerm(key: Key('el-2'), hidden: true),
          DescriptionTerm(key: Key('el-3'), hidden: true),
          DescriptionTerm(key: Key('el-4'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          DescriptionTerm(key: Key('el-1'), hidden: true),
          DescriptionTerm(key: Key('el-2'), hidden: false),
          DescriptionTerm(key: Key('el-3'), hidden: null),
          DescriptionTerm(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set "click" event listener only if provided', () async {
      ...
      await app!.buildChildren(
        widgets: [
          DescriptionTerm(key: Key('el-1')),
          DescriptionTerm(key: Key('el-2'), onClick: null),
          DescriptionTerm(key: Key('el-3'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear "click" event listener', () async {
      ...
      await app!.buildChildren(
        widgets: [
          DescriptionTerm(key: Key('el-1')),
          DescriptionTerm(key: Key('el-2'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set style', () async {
      await app!.buildChildren(
        widgets: [
          DescriptionTerm(key: Key('widget-1'), style: 'some style'),
          DescriptionTerm(key: Key('widget-2'), style: 'some "messy" style'),
          DescriptionTerm(key: Key('widget-3'), style: "some 'messy' style"),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
    ...
    test('should set title', () async {
      await app!.buildChildren(
        widgets: [
          DescriptionTerm(key: Key('widget-1'), title: 'some title'),
          DescriptionTerm(key: Key('widget-2'), title: 'some "messy" title'),
          DescriptionTerm(key: Key('widget-3'), title: "some 'messy' title"),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
    ...
    test('should call ref with correct element', () async {
      ...
      await app!.buildChildren(
        widgets: [
          DescriptionTerm(id: 'some-id-1', ref: (el) => el1 = el),
          DescriptionTerm(id: 'some-id-2', ref: (el) => el2 = el),
          DescriptionTerm(id: 'some-id-3', ref: (el) => el3 = el),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set correct types and markup', () async {
      await app!.buildChildren(
        widgets: [
          DescriptionTerm(key: Key('some-key-3')),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          DescriptionTerm(key: Key('some-key-1')),
          DescriptionTerm(key: Key('some-key-2')),
          DescriptionTerm(key: Key('some-key-3')),
        ],
        parentRenderElement: app!.appRenderElement,
      );
