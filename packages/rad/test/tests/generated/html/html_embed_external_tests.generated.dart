...
void html_embed_external_test() {
  group('HTML EmbedExternal tests:', () {
    ...
    test('should call ref with correct element', () async {
      ...
      await app!.buildChildren(
        widgets: [
          EmbedExternal(id: 'some-id-1', ref: (el) => el1 = el),
          EmbedExternal(id: 'some-id-2', ref: (el) => el2 = el),
          EmbedExternal(id: 'some-id-3', ref: (el) => el3 = el),
        ],
        parentRenderElement: app!.appRenderElement,
      );
