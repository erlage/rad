  ...
  group('HTML BreakLine tests:', () {
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          BreakLine(key: GlobalKey('some-key-1'), id: 'some-id-1'),
          BreakLine(key: GlobalKey('some-key-2'), id: 'some-id-2'),
          BreakLine(key: GlobalKey('some-key-3'), id: 'some-id-3'),
        ],
    ...
    test('should set attribute "hidden" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          BreakLine(key: GlobalKey('el-1'), hidden: false),
          BreakLine(key: GlobalKey('el-2'), hidden: null),
          BreakLine(key: GlobalKey('el-3'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "hidden" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          BreakLine(key: GlobalKey('el-1'), hidden: true),
          BreakLine(key: GlobalKey('el-2'), hidden: true),
          BreakLine(key: GlobalKey('el-3'), hidden: true),
          BreakLine(key: GlobalKey('el-4'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          BreakLine(key: GlobalKey('el-1'), hidden: true),
          BreakLine(key: GlobalKey('el-2'), hidden: false),
          BreakLine(key: GlobalKey('el-3'), hidden: null),
          BreakLine(key: GlobalKey('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set "click" event listener only if provided', () async {
      ...
      await app!.buildChildren(
        widgets: [
          BreakLine(key: GlobalKey('el-1')),
          BreakLine(key: GlobalKey('el-2'), onClick: null),
          BreakLine(key: GlobalKey('el-3'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear "click" event listner', () async {
      ...
      await app!.buildChildren(
        widgets: [
          BreakLine(key: GlobalKey('el-1')),
          BreakLine(key: GlobalKey('el-2'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set correct types and markup', () async {
      await app!.buildChildren(
        widgets: [
          BreakLine(key: GlobalKey('some-key-3')),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          BreakLine(key: GlobalKey('some-key-1')),
          BreakLine(key: GlobalKey('some-key-2')),
          BreakLine(key: GlobalKey('some-key-3')),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
