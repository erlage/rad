  ...
  group('HTML TableHeaderCell tests:', () {
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          TableHeaderCell(key: GlobalKey('some-key-1'), id: 'some-id-1'),
          TableHeaderCell(key: GlobalKey('some-key-2'), id: 'some-id-2'),
          TableHeaderCell(key: GlobalKey('some-key-3'), id: 'some-id-3'),
        ],
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          TableHeaderCell(key: GlobalKey('el-1'), classAttribute: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "onClickAttribute" if updated value is null',
      ...
      await app!.updateChildren(
        widgets: [
          TableHeaderCell(key: GlobalKey('el-1'), onClickAttribute: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set correct types and markup', () async {
      await app!.buildChildren(
        widgets: [
          TableHeaderCell(key: GlobalKey('some-key-3')),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          TableHeaderCell(key: GlobalKey('some-key-1')),
          TableHeaderCell(key: GlobalKey('some-key-2')),
          TableHeaderCell(key: GlobalKey('some-key-3')),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
