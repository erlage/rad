...
void html_input_color_test() {
  group('HTML InputColor tests:', () {
    ...
    test('should call ref with correct element', () async {
      ...
      await app!.buildChildren(
        widgets: [
          InputColor(id: 'some-id-1', ref: (el) => el1 = el),
          InputColor(id: 'some-id-2', ref: (el) => el2 = el),
          InputColor(id: 'some-id-3', ref: (el) => el3 = el),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set property "value"', () async {
      await app!.buildChildren(
        widgets: [
          InputColor(key: Key('el-1'), value: '#ffffff'),
          InputColor(key: Key('el-2'), value: '#cccccc'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update property "value"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputColor(key: Key('el-1'), value: '#2c2c2c'),
          InputColor(key: Key('el-2'), value: '#cccccc'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
