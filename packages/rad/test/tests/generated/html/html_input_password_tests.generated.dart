...
void html_input_password_test() {
  group('HTML InputPassword tests:', () {
    ...
    test('should call ref with correct element', () async {
      ...
      await app!.buildChildren(
        widgets: [
          InputPassword(id: 'some-id-1', ref: (el) => el1 = el),
          InputPassword(id: 'some-id-2', ref: (el) => el2 = el),
          InputPassword(id: 'some-id-3', ref: (el) => el3 = el),
        ],
        parentRenderElement: app!.appRenderElement,
      );
