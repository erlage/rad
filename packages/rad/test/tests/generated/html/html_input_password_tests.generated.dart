...
void html_input_password_test() {
  group('HTML InputPassword tests:', () {
    ...
    test('should set attribute "dirname"', () async {
      await app!.buildChildren(
        widgets: [
          InputPassword(key: Key('el-1'), dirName: 'some-dirname'),
          InputPassword(key: Key('el-2'), dirName: 'another-dirname'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "dirname"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputPassword(key: Key('el-1'), dirName: 'updated-dirname'),
          InputPassword(key: Key('el-2'), dirName: 'another-dirname'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should clear attribute "dirname" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputPassword(key: Key('el-1'), dirName: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
