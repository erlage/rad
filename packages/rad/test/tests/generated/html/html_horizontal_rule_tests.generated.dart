  ...
  group('HTML HorizontalRule tests:', () {
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          HorizontalRule(key: Key('some-key-1'), id: 'some-id-1'),
          HorizontalRule(key: Key('some-key-2'), id: 'some-id-2'),
          HorizontalRule(key: Key('some-key-3'), id: 'some-id-3'),
        ],
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          HorizontalRule(key: Key('el-1'), className: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "hidden" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          HorizontalRule(key: Key('el-1'), hidden: false),
          HorizontalRule(key: Key('el-2'), hidden: null),
          HorizontalRule(key: Key('el-3'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "hidden" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          HorizontalRule(key: Key('el-1'), hidden: true),
          HorizontalRule(key: Key('el-2'), hidden: true),
          HorizontalRule(key: Key('el-3'), hidden: true),
          HorizontalRule(key: Key('el-4'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          HorizontalRule(key: Key('el-1'), hidden: true),
          HorizontalRule(key: Key('el-2'), hidden: false),
          HorizontalRule(key: Key('el-3'), hidden: null),
          HorizontalRule(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set "click" event listener only if provided', () async {
      ...
      await app!.buildChildren(
        widgets: [
          HorizontalRule(key: Key('el-1')),
          HorizontalRule(key: Key('el-2'), onClick: null),
          HorizontalRule(key: Key('el-3'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear "click" event listener', () async {
      ...
      await app!.buildChildren(
        widgets: [
          HorizontalRule(key: Key('el-1')),
          HorizontalRule(key: Key('el-2'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should call ref with correct element', () async {
      ...
      await app!.buildChildren(
        widgets: [
          HorizontalRule(id: 'some-id-1', ref: (el) => el1 = el),
          HorizontalRule(id: 'some-id-2', ref: (el) => el2 = el),
          HorizontalRule(id: 'some-id-3', ref: (el) => el3 = el),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set correct types and markup', () async {
      await app!.buildChildren(
        widgets: [
          HorizontalRule(key: Key('some-key-3')),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          HorizontalRule(key: Key('some-key-1')),
          HorizontalRule(key: Key('some-key-2')),
          HorizontalRule(key: Key('some-key-3')),
        ],
        parentRenderElement: app!.appRenderElement,
      );
