...
void html_strike_through_test() {
  group('HTML StrikeThrough tests:', () {
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          StrikeThrough(key: Key('el-1'), className: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should call ref with correct element', () async {
      ...
      await app!.buildChildren(
        widgets: [
          StrikeThrough(id: 'some-id-1', ref: (el) => el1 = el),
          StrikeThrough(id: 'some-id-2', ref: (el) => el2 = el),
          StrikeThrough(id: 'some-id-3', ref: (el) => el3 = el),
        ],
        parentRenderElement: app!.appRenderElement,
      );
