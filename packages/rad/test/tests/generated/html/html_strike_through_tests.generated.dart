...
void html_strike_through_test() {
  group('HTML StrikeThrough tests:', () {
    RT_AppRunner? app;
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          StrikeThrough(key: Key('some-key-1'), id: 'some-id-1'),
          StrikeThrough(key: Key('some-key-2'), id: 'some-id-2'),
          StrikeThrough(key: Key('some-key-3'), id: 'some-id-3'),
        ],
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          StrikeThrough(key: Key('el-1'), classAttribute: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "hidden" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          StrikeThrough(key: Key('el-1'), hidden: false),
          StrikeThrough(key: Key('el-2'), hidden: null),
          StrikeThrough(key: Key('el-3'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "hidden" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          StrikeThrough(key: Key('el-1'), hidden: true),
          StrikeThrough(key: Key('el-2'), hidden: true),
          StrikeThrough(key: Key('el-3'), hidden: true),
          StrikeThrough(key: Key('el-4'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          StrikeThrough(key: Key('el-1'), hidden: true),
          StrikeThrough(key: Key('el-2'), hidden: false),
          StrikeThrough(key: Key('el-3'), hidden: null),
          StrikeThrough(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "onClickAttribute"', () async {
      await app!.buildChildren(
        widgets: [
          StrikeThrough(key: Key('el-1'), onClickAttribute: 'some-on-click'),
          StrikeThrough(key: Key('el-2'), onClickAttribute: 'another-on-click'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "onClickAttribute"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          StrikeThrough(key: Key('el-1'), onClickAttribute: 'updated-on-click'),
          StrikeThrough(key: Key('el-2'), onClickAttribute: 'another-on-click'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should clear attribute "onClickAttribute" if updated value is null',
      ...
      await app!.updateChildren(
        widgets: [
          StrikeThrough(key: Key('el-1'), onClickAttribute: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set "click" event listener only if provided', () async {
      ...
      await app!.buildChildren(
        widgets: [
          StrikeThrough(key: Key('el-1')),
          StrikeThrough(key: Key('el-2'), onClick: null),
          StrikeThrough(key: Key('el-3'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear "click" event listner', () async {
      ...
      await app!.buildChildren(
        widgets: [
          StrikeThrough(key: Key('el-1')),
          StrikeThrough(key: Key('el-2'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set style', () async {
      await app!.buildChildren(
        widgets: [
          StrikeThrough(key: Key('widget-1'), style: 'some style'),
          StrikeThrough(key: Key('widget-2'), style: 'some "messy" style'),
          StrikeThrough(key: Key('widget-3'), style: "some 'messy' style"),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
    ...
    test('should set title', () async {
      await app!.buildChildren(
        widgets: [
          StrikeThrough(key: Key('widget-1'), title: 'some title'),
          StrikeThrough(key: Key('widget-2'), title: 'some "messy" title'),
          StrikeThrough(key: Key('widget-3'), title: "some 'messy' title"),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
    ...
    test('should set correct types and markup', () async {
      await app!.buildChildren(
        widgets: [
          StrikeThrough(key: Key('some-key-3')),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          StrikeThrough(key: Key('some-key-1')),
          StrikeThrough(key: Key('some-key-2')),
          StrikeThrough(key: Key('some-key-3')),
        ],
        parentRenderElement: app!.appRenderElement,
      );
