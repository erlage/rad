...
void html_input_telephone_test() {
  group('HTML InputTelephone tests:', () {
    ...
    test('should call ref with correct element', () async {
      ...
      await app!.buildChildren(
        widgets: [
          InputTelephone(id: 'some-id-1', ref: (el) => el1 = el),
          InputTelephone(id: 'some-id-2', ref: (el) => el2 = el),
          InputTelephone(id: 'some-id-3', ref: (el) => el3 = el),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set property "value"', () async {
      await app!.buildChildren(
        widgets: [
          InputTelephone(key: Key('el-1'), value: '12'),
          InputTelephone(key: Key('el-2'), value: '10'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update property "value"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          InputTelephone(key: Key('el-1'), value: '08'),
          InputTelephone(key: Key('el-2'), value: '10'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
