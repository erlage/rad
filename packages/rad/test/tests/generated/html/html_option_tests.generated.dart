  ...
  group('HTML Option tests:', () {
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          Option(key: Key('some-key-1'), id: 'some-id-1'),
          Option(key: Key('some-key-2'), id: 'some-id-2'),
          Option(key: Key('some-key-3'), id: 'some-id-3'),
        ],
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          Option(key: Key('el-1'), classAttribute: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "hidden" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          Option(key: Key('el-1'), hidden: false),
          Option(key: Key('el-2'), hidden: null),
          Option(key: Key('el-3'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "hidden" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          Option(key: Key('el-1'), hidden: true),
          Option(key: Key('el-2'), hidden: true),
          Option(key: Key('el-3'), hidden: true),
          Option(key: Key('el-4'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          Option(key: Key('el-1'), hidden: true),
          Option(key: Key('el-2'), hidden: false),
          Option(key: Key('el-3'), hidden: null),
          Option(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should set attribute "onClickAttribute"', () async {
      await app!.buildChildren(
        widgets: [
          Option(key: Key('el-1'), onClickAttribute: 'some-on-click'),
          Option(key: Key('el-2'), onClickAttribute: 'another-on-click'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "onClickAttribute"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          Option(key: Key('el-1'), onClickAttribute: 'updated-on-click'),
          Option(key: Key('el-2'), onClickAttribute: 'another-on-click'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should clear attribute "onClickAttribute" if updated value is null',
      ...
      await app!.updateChildren(
        widgets: [
          Option(key: Key('el-1'), onClickAttribute: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set "click" event listener only if provided', () async {
      ...
      await app!.buildChildren(
        widgets: [
          Option(key: Key('el-1')),
          Option(key: Key('el-2'), onClick: null),
          Option(key: Key('el-3'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear "click" event listner', () async {
      ...
      await app!.buildChildren(
        widgets: [
          Option(key: Key('el-1')),
          Option(key: Key('el-2'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          Option(key: Key('some-key-1')),
          Option(key: Key('some-key-2')),
          Option(key: Key('some-key-3')),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "label"', () async {
      await app!.buildChildren(
        widgets: [
          Option(key: Key('el-1'), label: 'some-label'),
          Option(key: Key('el-2'), label: 'another-label'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "label"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          Option(key: Key('el-1'), label: 'updated-label'),
          Option(key: Key('el-2'), label: 'another-label'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should clear attribute "label" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          Option(key: Key('el-1'), label: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "value"', () async {
      await app!.buildChildren(
        widgets: [
          Option(key: Key('el-1'), value: 'some-value'),
          Option(key: Key('el-2'), value: 'another-value'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "value"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          Option(key: Key('el-1'), value: 'updated-value'),
          Option(key: Key('el-2'), value: 'another-value'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should clear attribute "value" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          Option(key: Key('el-1'), value: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "selected" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          Option(key: Key('el-1'), selected: false),
          Option(key: Key('el-2'), selected: null),
          Option(key: Key('el-3'), selected: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      expect(domNode1.getAttribute('selected'), equals(null));
      expect(domNode2.getAttribute('selected'), equals(null));
      expect(domNode3.getAttribute('selected'), equals('true'));
    });
    ...
    test('should clear attribute "selected" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          Option(key: Key('el-1'), selected: true),
          Option(key: Key('el-2'), selected: true),
          Option(key: Key('el-3'), selected: true),
          Option(key: Key('el-4'), selected: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          Option(key: Key('el-1'), selected: true),
          Option(key: Key('el-2'), selected: false),
          Option(key: Key('el-3'), selected: null),
          Option(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      ...
      expect(domNode1.getAttribute('selected'), equals('true'));
      expect(domNode2.getAttribute('selected'), equals(null));
      expect(domNode3.getAttribute('selected'), equals(null));
      expect(domNode4.getAttribute('selected'), equals(null));
    });

    test('should set attribute "disabled" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          Option(key: Key('el-1'), disabled: false),
          Option(key: Key('el-2'), disabled: null),
          Option(key: Key('el-3'), disabled: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "disabled" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          Option(key: Key('el-1'), disabled: true),
          Option(key: Key('el-2'), disabled: true),
          Option(key: Key('el-3'), disabled: true),
          Option(key: Key('el-4'), disabled: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          Option(key: Key('el-1'), disabled: true),
          Option(key: Key('el-2'), disabled: false),
          Option(key: Key('el-3'), disabled: null),
          Option(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
