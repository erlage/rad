...
void html_text_area_test() {
  group('HTML TextArea tests:', () {
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          TextArea(key: Key('el-1'), className: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should call ref with correct element', () async {
      ...
      await app!.buildChildren(
        widgets: [
          TextArea(id: 'some-id-1', ref: (el) => el1 = el),
          TextArea(id: 'some-id-2', ref: (el) => el2 = el),
          TextArea(id: 'some-id-3', ref: (el) => el3 = el),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "autocomplete"', () async {
      await app!.buildChildren(
        widgets: [
          TextArea(key: Key('el-1'), autoComplete: 'some-autocomplete'),
          TextArea(key: Key('el-2'), autoComplete: 'another-autocomplete'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "autocomplete"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          TextArea(key: Key('el-1'), autoComplete: 'updated-autocomplete'),
          TextArea(key: Key('el-2'), autoComplete: 'another-autocomplete'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test(
      ...
      await app!.updateChildren(
        widgets: [
          TextArea(key: Key('el-1'), autoComplete: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "form"', () async {
      await app!.buildChildren(
        widgets: [
          TextArea(key: Key('el-1'), form: 'some-form'),
          TextArea(key: Key('el-2'), form: 'another-form'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "form"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          TextArea(key: Key('el-1'), form: 'updated-form'),
          TextArea(key: Key('el-2'), form: 'another-form'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should clear attribute "form" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          TextArea(key: Key('el-1'), form: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "spellcheck"', () async {
      await app!.buildChildren(
        widgets: [
          TextArea(key: Key('el-1'), spellCheck: SpellCheckType.trueValue),
          TextArea(key: Key('el-2'), spellCheck: SpellCheckType.falseValue),
          TextArea(key: Key('el-3'), spellCheck: SpellCheckType.defaultValue),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "spellcheck"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          TextArea(key: Key('el-1')),
          TextArea(key: Key('el-2'), spellCheck: null),
          TextArea(key: Key('el-3'), spellCheck: SpellCheckType.falseValue),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "wrap"', () async {
      await app!.buildChildren(
        widgets: [
          TextArea(key: Key('el-1'), wrap: WrapType.hard),
          TextArea(key: Key('el-2'), wrap: WrapType.soft),
          TextArea(key: Key('el-3'), wrap: WrapType.off),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "wrap"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          TextArea(key: Key('el-1')),
          TextArea(key: Key('el-2'), wrap: null),
          TextArea(key: Key('el-3'), wrap: WrapType.soft),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set property "value"', () async {
      await app!.buildChildren(
        widgets: [
          TextArea(key: Key('el-1'), value: 'some-value'),
          TextArea(key: Key('el-2'), value: 'another-value'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      expect((domNode1 as TextAreaElement).value, equals('some-value'));
      expect((domNode2 as TextAreaElement).value, equals('another-value'));
    });
    ...
    test('should update property "value"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          TextArea(key: Key('el-1'), value: 'updated-value'),
          TextArea(key: Key('el-2'), value: 'another-value'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      ...
      expect((domNode1 as TextAreaElement).value, equals('updated-value'));
      expect((domNode2 as TextAreaElement).value, equals('another-value'));
    });
    ...
    test('should clear property "value"', () async {
      ...
      expect((domNode1 as TextAreaElement).value, equals(''));
      expect((domNode2 as TextAreaElement).value, equals(''));
    });
    ...
    test('should clear property "value" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          TextArea(key: Key('el-1'), value: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
