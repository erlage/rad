...
void html_ordered_list_test() {
  group('HTML OrderedList tests:', () {
    RT_AppRunner? app;
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          OrderedList(key: Key('some-key-1'), id: 'some-id-1'),
          OrderedList(key: Key('some-key-2'), id: 'some-id-2'),
          OrderedList(key: Key('some-key-3'), id: 'some-id-3'),
        ],
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          OrderedList(key: Key('el-1'), className: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "hidden" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          OrderedList(key: Key('el-1'), hidden: false),
          OrderedList(key: Key('el-2'), hidden: null),
          OrderedList(key: Key('el-3'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "hidden" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          OrderedList(key: Key('el-1'), hidden: true),
          OrderedList(key: Key('el-2'), hidden: true),
          OrderedList(key: Key('el-3'), hidden: true),
          OrderedList(key: Key('el-4'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          OrderedList(key: Key('el-1'), hidden: true),
          OrderedList(key: Key('el-2'), hidden: false),
          OrderedList(key: Key('el-3'), hidden: null),
          OrderedList(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set "click" event listener only if provided', () async {
      ...
      await app!.buildChildren(
        widgets: [
          OrderedList(key: Key('el-1')),
          OrderedList(key: Key('el-2'), onClick: null),
          OrderedList(key: Key('el-3'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear "click" event listener', () async {
      ...
      await app!.buildChildren(
        widgets: [
          OrderedList(key: Key('el-1')),
          OrderedList(key: Key('el-2'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set style', () async {
      await app!.buildChildren(
        widgets: [
          OrderedList(key: Key('widget-1'), style: 'some style'),
          OrderedList(key: Key('widget-2'), style: 'some "messy" style'),
          OrderedList(key: Key('widget-3'), style: "some 'messy' style"),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
    ...
    test('should set title', () async {
      await app!.buildChildren(
        widgets: [
          OrderedList(key: Key('widget-1'), title: 'some title'),
          OrderedList(key: Key('widget-2'), title: 'some "messy" title'),
          OrderedList(key: Key('widget-3'), title: "some 'messy' title"),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
    ...
    test('should call ref with correct element', () async {
      ...
      await app!.buildChildren(
        widgets: [
          OrderedList(id: 'some-id-1', ref: (el) => el1 = el),
          OrderedList(id: 'some-id-2', ref: (el) => el2 = el),
          OrderedList(id: 'some-id-3', ref: (el) => el3 = el),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set correct types and markup', () async {
      await app!.buildChildren(
        widgets: [
          OrderedList(key: Key('some-key-3')),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          OrderedList(key: Key('some-key-1')),
          OrderedList(key: Key('some-key-2')),
          OrderedList(key: Key('some-key-3')),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "start"', () async {
      await app!.buildChildren(
        widgets: [
          OrderedList(key: Key('el-1'), start: 10),
          OrderedList(key: Key('el-2'), start: 0),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "start"', () async {
      await app!.buildChildren(
        widgets: [
          OrderedList(key: Key('el-1'), start: 10),
          OrderedList(key: Key('el-2'), start: 10),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          OrderedList(key: Key('el-1'), start: 20),
          OrderedList(key: Key('el-2'), start: 20),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "start" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          OrderedList(key: Key('el-1'), start: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should not set attribute "start" if provided value is null',
        () async {
      await app!.buildChildren(
        widgets: [
          OrderedList(key: Key('el-1'), start: null),
    ...
    test('should set attribute "reversed" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          OrderedList(key: Key('el-1'), reversed: false),
          OrderedList(key: Key('el-2'), reversed: null),
          OrderedList(key: Key('el-3'), reversed: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "reversed" if updated value is not true',
        () async {
      await app!.buildChildren(
        widgets: [
          OrderedList(key: Key('el-1'), reversed: true),
          OrderedList(key: Key('el-2'), reversed: true),
          OrderedList(key: Key('el-3'), reversed: true),
          OrderedList(key: Key('el-4'), reversed: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          OrderedList(key: Key('el-1'), reversed: true),
          OrderedList(key: Key('el-2'), reversed: false),
          OrderedList(key: Key('el-3'), reversed: null),
          OrderedList(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should set ordered list attribute "type"', () async {
      await app!.buildChildren(
        widgets: [
          OrderedList(key: Key('el-1'), type: ListType.lowerCaseLetters),
          OrderedList(key: Key('el-2'), type: ListType.upperCaseLetters),
          OrderedList(key: Key('el-3'), type: ListType.lowerCaseRomanNumerals),
          OrderedList(key: Key('el-4'), type: ListType.upperCaseRomanNumerals),
          OrderedList(key: Key('el-5'), type: ListType.numbers),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update ordered list attribute "type"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          OrderedList(key: Key('el-1')),
          OrderedList(key: Key('el-2'), type: null),
          OrderedList(key: Key('el-3'), type: ListType.upperCaseRomanNumerals),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
