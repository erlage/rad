...
void html_image_map_test() {
  group('HTML ImageMap tests:', () {
    RT_AppRunner? app;
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          ImageMap(key: Key('some-key-1'), id: 'some-id-1'),
          ImageMap(key: Key('some-key-2'), id: 'some-id-2'),
          ImageMap(key: Key('some-key-3'), id: 'some-id-3'),
        ],
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          ImageMap(key: Key('el-1'), className: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "hidden" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          ImageMap(key: Key('el-1'), hidden: false),
          ImageMap(key: Key('el-2'), hidden: null),
          ImageMap(key: Key('el-3'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "hidden" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          ImageMap(key: Key('el-1'), hidden: true),
          ImageMap(key: Key('el-2'), hidden: true),
          ImageMap(key: Key('el-3'), hidden: true),
          ImageMap(key: Key('el-4'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          ImageMap(key: Key('el-1'), hidden: true),
          ImageMap(key: Key('el-2'), hidden: false),
          ImageMap(key: Key('el-3'), hidden: null),
          ImageMap(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set "click" event listener only if provided', () async {
      ...
      await app!.buildChildren(
        widgets: [
          ImageMap(key: Key('el-1')),
          ImageMap(key: Key('el-2'), onClick: null),
          ImageMap(key: Key('el-3'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear "click" event listener', () async {
      ...
      await app!.buildChildren(
        widgets: [
          ImageMap(key: Key('el-1')),
          ImageMap(key: Key('el-2'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set style', () async {
      await app!.buildChildren(
        widgets: [
          ImageMap(key: Key('widget-1'), style: 'some style'),
          ImageMap(key: Key('widget-2'), style: 'some "messy" style'),
          ImageMap(key: Key('widget-3'), style: "some 'messy' style"),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set title', () async {
      await app!.buildChildren(
        widgets: [
          ImageMap(key: Key('widget-1'), title: 'some title'),
          ImageMap(key: Key('widget-2'), title: 'some "messy" title'),
          ImageMap(key: Key('widget-3'), title: "some 'messy' title"),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should call ref with correct element', () async {
      ...
      await app!.buildChildren(
        widgets: [
          ImageMap(id: 'some-id-1', ref: (el) => el1 = el),
          ImageMap(id: 'some-id-2', ref: (el) => el2 = el),
          ImageMap(id: 'some-id-3', ref: (el) => el3 = el),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          ImageMap(key: Key('some-key-1')),
          ImageMap(key: Key('some-key-2')),
          ImageMap(key: Key('some-key-3')),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "name"', () async {
      await app!.buildChildren(
        widgets: [
          ImageMap(key: Key('el-1'), name: 'some-name'),
          ImageMap(key: Key('el-2'), name: 'another-name'),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should update attribute "name"', () async {
      ...
      await app!.updateChildren(
        widgets: [
          ImageMap(key: Key('el-1'), name: 'updated-name'),
          ImageMap(key: Key('el-2'), name: 'another-name'),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    ...
    test('should clear attribute "name" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          ImageMap(key: Key('el-1'), name: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
