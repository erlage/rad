...
void html_details_test() {
  group('HTML Details tests:', () {
    RT_AppRunner? app;
    ...
    test('should set id', () async {
      await app!.buildChildren(
        widgets: [
          Details(key: Key('some-key-1'), id: 'some-id-1'),
          Details(key: Key('some-key-2'), id: 'some-id-2'),
          Details(key: Key('some-key-3'), id: 'some-id-3'),
        ],
    ...
    test('should clear attribute "classes" if updated value is null', () async {
      ...
      await app!.updateChildren(
        widgets: [
          Details(key: Key('el-1'), className: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "hidden" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          Details(key: Key('el-1'), hidden: false),
          Details(key: Key('el-2'), hidden: null),
          Details(key: Key('el-3'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear attribute "hidden" if updated value is not true',
      ...
      await app!.buildChildren(
        widgets: [
          Details(key: Key('el-1'), hidden: true),
          Details(key: Key('el-2'), hidden: true),
          Details(key: Key('el-3'), hidden: true),
          Details(key: Key('el-4'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          Details(key: Key('el-1'), hidden: true),
          Details(key: Key('el-2'), hidden: false),
          Details(key: Key('el-3'), hidden: null),
          Details(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set "click" event listener only if provided', () async {
      ...
      await app!.buildChildren(
        widgets: [
          Details(key: Key('el-1')),
          Details(key: Key('el-2'), onClick: null),
          Details(key: Key('el-3'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should clear "click" event listener', () async {
      ...
      await app!.buildChildren(
        widgets: [
          Details(key: Key('el-1')),
          Details(key: Key('el-2'), onClick: listener),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set style', () async {
      await app!.buildChildren(
        widgets: [
          Details(key: Key('widget-1'), style: 'some style'),
          Details(key: Key('widget-2'), style: 'some "messy" style'),
          Details(key: Key('widget-3'), style: "some 'messy' style"),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
    ...
    test('should set title', () async {
      await app!.buildChildren(
        widgets: [
          Details(key: Key('widget-1'), title: 'some title'),
          Details(key: Key('widget-2'), title: 'some "messy" title'),
          Details(key: Key('widget-3'), title: "some 'messy' title"),
        ],
        parentRenderElement: RT_TestBed.rootRenderElement,
      );
    ...
    test('should call ref with correct element', () async {
      ...
      await app!.buildChildren(
        widgets: [
          Details(id: 'some-id-1', ref: (el) => el1 = el),
          Details(id: 'some-id-2', ref: (el) => el2 = el),
          Details(id: 'some-id-3', ref: (el) => el3 = el),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set key', () async {
      await app!.buildChildren(
        widgets: [
          Details(key: Key('some-key-1')),
          Details(key: Key('some-key-2')),
          Details(key: Key('some-key-3')),
        ],
        parentRenderElement: app!.appRenderElement,
      );
    ...
    test('should set attribute "open" only if its true', () async {
      await app!.buildChildren(
        widgets: [
          Details(key: Key('el-1'), open: false),
          Details(key: Key('el-2'), open: null),
          Details(key: Key('el-3'), open: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      expect(domNode1.getAttribute('open'), equals(null));
      expect(domNode2.getAttribute('open'), equals(null));
      expect(domNode3.getAttribute('open'), equals('true'));
    });

    test('should clear attribute "open" if updated value is not true',
        () async {
      await app!.buildChildren(
        widgets: [
          Details(key: Key('el-1'), open: true),
          Details(key: Key('el-2'), open: true),
          Details(key: Key('el-3'), open: true),
          Details(key: Key('el-4'), open: true),
        ],
        parentRenderElement: app!.appRenderElement,
      );
      ...
      await app!.updateChildren(
        widgets: [
          Details(key: Key('el-1'), open: true),
          Details(key: Key('el-2'), open: false),
          Details(key: Key('el-3'), open: null),
          Details(key: Key('el-4')),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
      ...
      expect(domNode1.getAttribute('open'), equals('true'));
      expect(domNode2.getAttribute('open'), equals(null));
      expect(domNode3.getAttribute('open'), equals(null));
      expect(domNode4.getAttribute('open'), equals(null));
    });
  });
}
