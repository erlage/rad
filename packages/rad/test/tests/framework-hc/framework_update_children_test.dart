          ...
          await app!.updateChildren(
            widgets: [
              RT_TestWidget(
                ...
                roEventDispose: () => testStack.push('dispose 1'),
              ),
            ],
          ...
          await app!.updateChildren(
            widgets: [
              RT_AnotherTestWidget(
                ...
                roEventDispose: () => testStack.push('dispose 2'),
              ),
            ],
            parentRenderElement: app!.appRenderElement,
            updateType: UpdateType.undefined,
          ...
          await app!.updateChildren(
            widgets: [
              RT_TestWidget(
                roEventRender: () => testStack.push('render 1a'),
                roEventUpdate: () => testStack.push('update 1a'),
                roEventDispose: () => testStack.push('dispose 1a'),
              ),
            ],
            parentRenderElement: app!.appRenderElement,
            updateType: UpdateType.undefined,
          ...
          await app!.updateChildren(
            widgets: [
              RT_AnotherTestWidget(
                roEventRender: () => testStack.push('render 1b'),
                roEventUpdate: () => testStack.push('update 1b'),
                roEventDispose: () => testStack.push('dispose 1b'),
              ),
            ],
            flagAddIfNotFound: true,
            parentRenderElement: app!.appRenderElement,
          ...
          await app!.updateChildren(
            widgets: [
              RT_AnotherTestWidget(
                ...
                roEventDispose: () => testStack.push('dispose 1c'),
              ),
            ],
            flagAddIfNotFound: true,
            parentRenderElement: app!.appRenderElement,
          ...
          await app!.updateChildren(
            widgets: [
              ...
              RT_TestWidget(
                ...
                roEventDispose: () => testStack.push('dispose 11'),
              ),
            ],
            parentRenderElement: app!.appRenderElement,
            updateType: UpdateType.undefined,
          ...
          await app!.updateChildren(
            widgets: [
              ...
              RT_AnotherTestWidget(
                ...
                roEventDispose: () => testStack.push('dispose 22'),
              ),
            ],
            parentRenderElement: app!.appRenderElement,
            updateType: UpdateType.undefined,
