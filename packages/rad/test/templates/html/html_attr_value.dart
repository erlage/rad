test('should set attribute "value"', () async {
    ...
    widgets: [
        __WidgetClass__(key: GlobalKey('el-1'), value: 'some-value'),
        __WidgetClass__(key: GlobalKey('el-2'), value: 'another-value'),
    ],
...
test('should update attribute "value"', () async {
    ...
    widgets: [
        __WidgetClass__(key: GlobalKey('el-1'), value: 'updated-value'),
        __WidgetClass__(key: GlobalKey('el-2'), value: 'another-value'),
    ],
