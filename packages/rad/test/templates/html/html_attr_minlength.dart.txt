test('should set attribute "minLength"', () async {
    await app!.buildChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), minLength: 10),
            __WidgetClass__(key: GlobalKey('el-2'), minLength: 0),
        ],
...
test('should update attribute "minLength"', () async {
    await app!.buildChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), minLength: 10),
            __WidgetClass__(key: GlobalKey('el-2'), minLength: 10),
        ],
        parentRenderElement: app!.appRenderElement,
    );
    ...
    await app!.updateChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), minLength: 20),
            __WidgetClass__(key: GlobalKey('el-2'), minLength: 20),
        ],
...
test('should clear attribute "minLength" if updated value is null', () async {
    ...
    await app!.updateChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), minLength: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    );
