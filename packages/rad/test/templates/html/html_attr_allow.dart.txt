test('should set attribute "allow"', () async {
    await app!.buildChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), allow: 'some-allow'),
            __WidgetClass__(key: GlobalKey('el-2'), allow: 'another-allow'),
        ],
...
test('should update attribute "allow"', () async {
    ...
    await app!.updateChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), allow: 'updated-allow'),
            __WidgetClass__(key: GlobalKey('el-2'), allow: 'another-allow'),
        ],
...
test('should clear attribute "allow" if updated value is null', () async {
   await app!.buildChildren(
    ...
    await app!.updateChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), allow: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    );
