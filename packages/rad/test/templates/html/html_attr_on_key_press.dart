...
test('should set "KeyPress" event listener only if provided', () async {
    ...
    await app!.buildChildren(
        widgets: [
            ...
            __WidgetClass__(key: GlobalKey('el-2'), onKeyPress: null),
            __WidgetClass__(key: GlobalKey('el-3'), onKeyPress: listener),
        ],
        parentRenderElement: app!.appRenderElement,
    );
...
test('should clear "KeyPress" event listner', () async {
    ...
    await app!.buildChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1')),
            __WidgetClass__(key: GlobalKey('el-2'), onKeyPress: listener),
        ],
        parentRenderElement: app!.appRenderElement,
    );
