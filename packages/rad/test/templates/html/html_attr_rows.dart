test('should set attribute "rows"', () async {
    await app!.buildChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), rows: 10),
            __WidgetClass__(key: GlobalKey('el-2'), rows: 0),
        ],
...
test('should update attribute "rows"', () async {
    await app!.buildChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), rows: 10),
            __WidgetClass__(key: GlobalKey('el-2'), rows: 10),
        ],
        parentRenderElement: app!.appRenderElement,
    );
    ...
    await app!.updateChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), rows: 20),
            __WidgetClass__(key: GlobalKey('el-2'), rows: 20),
        ],
...
test('should clear attribute "rows" if updated value is null', () async {
    ...
    await app!.updateChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), rows: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    );
