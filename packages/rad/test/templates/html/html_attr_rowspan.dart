test('should set attribute "rowSpan"', () async {
    await app!.buildChildren(
        widgets: [
            __WidgetClass__(key: Key('el-1'), rowSpan: 10),
            __WidgetClass__(key: Key('el-2'), rowSpan: 0),
        ],
...
test('should update attribute "rowSpan"', () async {
    await app!.buildChildren(
        widgets: [
            __WidgetClass__(key: Key('el-1'), rowSpan: 10),
            __WidgetClass__(key: Key('el-2'), rowSpan: 10),
        ],
        parentRenderElement: app!.appRenderElement,
    );
    ...
    await app!.updateChildren(
        widgets: [
            __WidgetClass__(key: Key('el-1'), rowSpan: 20),
            __WidgetClass__(key: Key('el-2'), rowSpan: 20),
        ],
...
test('should clear attribute "rowSpan" if updated value is null', () async {
    ...
    await app!.updateChildren(
        widgets: [
            __WidgetClass__(key: Key('el-1'), rowSpan: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    );
