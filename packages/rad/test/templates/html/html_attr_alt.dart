test('should set attribute "alt"', () async {
    await app!.buildChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), alt: 'some-alt'),
            __WidgetClass__(key: GlobalKey('el-2'), alt: 'another-alt'),
        ],
...
test('should update attribute "alt"', () async {
    ...
    await app!.updateChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), alt: 'updated-alt'),
            __WidgetClass__(key: GlobalKey('el-2'), alt: 'another-alt'),
        ],
...
test('should clear attribute "alt" if updated value is null', () async {
   await app!.buildChildren(
    ...
    await app!.updateChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), alt: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    );
