test('should set attribute "hidden" only if its true', () async {
    await app!.buildChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), hidden: false),
            __WidgetClass__(key: GlobalKey('el-2'), hidden: null),
            __WidgetClass__(key: GlobalKey('el-3'), hidden: true),
        ],
...
test('should clear attribute "hidden" if updated value is not true', () async {
    await app!.buildChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), hidden: true),
            __WidgetClass__(key: GlobalKey('el-2'), hidden: true),
            __WidgetClass__(key: GlobalKey('el-3'), hidden: true),
            __WidgetClass__(key: GlobalKey('el-4'), hidden: true),
        ],
        parentRenderElement: app!.appRenderElement,
    );
    ...
    await app!.updateChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), hidden: true),
            __WidgetClass__(key: GlobalKey('el-2'), hidden: false),
            __WidgetClass__(key: GlobalKey('el-3'), hidden: null),
