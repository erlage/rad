test('should set attribute "rel"', () async {
    ...
    widgets: [
        __WidgetClass__(key: Key('el-1'), rel: 'some-rel'),
        __WidgetClass__(key: Key('el-2'), rel: 'another-rel'),
    ],
...
test('should update attribute "rel"', () async {
    ...
    widgets: [
        __WidgetClass__(key: Key('el-1'), rel: 'updated-rel'),
        __WidgetClass__(key: Key('el-2'), rel: 'another-rel'),
    ],
...
test('should clear attribute "rel" if updated value is null', () async {
   await app!.buildChildren(
    ...
    await app!.updateChildren(
        widgets: [
            __WidgetClass__(key: Key('el-1'), rel: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    );
