test('should set property "value"', () async {
  await app!.buildChildren(
    widgets: [
      __WidgetClass__(key: Key('el-1'), value: '2022-07-13T02:23'),
      __WidgetClass__(key: Key('el-2'), value: '2022-07-13T02:25'),
    ],
...
test('should update property "value"', () async {
  ...
  await app!.updateChildren(
    widgets: [
      __WidgetClass__(key: Key('el-1'), value: '2022-07-13T02:28'),
      __WidgetClass__(key: Key('el-2'), value: '2022-07-13T02:25'),
    ],
