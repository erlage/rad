test('should set attribute "maxLength"', () async {
    await app!.buildChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), maxLength: 10),
            __WidgetClass__(key: GlobalKey('el-2'), maxLength: 0),
        ],
...
test('should update attribute "maxLength"', () async {
    await app!.buildChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), maxLength: 10),
            __WidgetClass__(key: GlobalKey('el-2'), maxLength: 10),
        ],
        parentRenderElement: app!.appRenderElement,
    );
    ...
    await app!.updateChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), maxLength: 20),
            __WidgetClass__(key: GlobalKey('el-2'), maxLength: 20),
        ],
...
test('should clear attribute "maxLength" if updated value is null', () async {
    ...
    await app!.updateChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), maxLength: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    );
