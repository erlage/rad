test('should set attribute "max"', () async {
    await app!.buildChildren(
        widgets: [
            __WidgetClass__(key: Key('el-1'), max: 10),
            __WidgetClass__(key: Key('el-2'), max: 0),
        ],
...
test('should update attribute "max"', () async {
    await app!.buildChildren(
        widgets: [
            __WidgetClass__(key: Key('el-1'), max: 10),
            __WidgetClass__(key: Key('el-2'), max: 10),
        ],
        parentRenderElement: app!.appRenderElement,
    );
    ...
    await app!.updateChildren(
        widgets: [
            __WidgetClass__(key: Key('el-1'), max: 20),
            __WidgetClass__(key: Key('el-2'), max: 20),
        ],
