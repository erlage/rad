test('should set attribute "value"', () async {
    await app!.buildChildren(
        widgets: [
            __WidgetClass__(key: Key('el-1'), value: 10.2),
            __WidgetClass__(key: Key('el-2'), value: 0),
        ],
...
test('should update attribute "value"', () async {
    await app!.buildChildren(
        widgets: [
            __WidgetClass__(key: Key('el-1'), value: 10.2),
            __WidgetClass__(key: Key('el-2'), value: 10.2),
        ],
        parentRenderElement: app!.appRenderElement,
    );
    ...
    await app!.updateChildren(
        widgets: [
            __WidgetClass__(key: Key('el-1'), value: 20.3),
            __WidgetClass__(key: Key('el-2'), value: 20.3),
        ],
