test('should set attribute "span"', () async {
    await app!.buildChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), span: 10),
            __WidgetClass__(key: GlobalKey('el-2'), span: 0),
        ],
...
test('should update attribute "span"', () async {
    await app!.buildChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), span: 10),
            __WidgetClass__(key: GlobalKey('el-2'), span: 10),
        ],
        parentRenderElement: app!.appRenderElement,
    );
    ...
    await app!.updateChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), span: 20),
            __WidgetClass__(key: GlobalKey('el-2'), span: 20),
        ],
...
test('should clear attribute "span" if updated value is null', () async {
    ...
    await app!.updateChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), span: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    );
