test('should set attribute "placeholder"', () async {
    ...
    widgets: [
        __WidgetClass__(key: GlobalKey('el-1'), placeholder: 'some-placeholder'),
        __WidgetClass__(key: GlobalKey('el-2'), placeholder: 'another-placeholder'),
    ],
...
test('should update attribute "placeholder"', () async {
    ...
    widgets: [
        __WidgetClass__(key: GlobalKey('el-1'), placeholder: 'updated-placeholder'),
        __WidgetClass__(key: GlobalKey('el-2'), placeholder: 'another-placeholder'),
    ],
...
test('should clear attribute "placeholder" if updated value is null', () async {
   await app!.buildChildren(
    ...
    await app!.updateChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), placeholder: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    );
