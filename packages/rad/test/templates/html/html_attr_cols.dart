test('should set attribute "cols"', () async {
    await app!.buildChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), cols: 10),
            __WidgetClass__(key: GlobalKey('el-2'), cols: 0),
        ],
...
test('should update attribute "cols"', () async {
    await app!.buildChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), cols: 10),
            __WidgetClass__(key: GlobalKey('el-2'), cols: 10),
        ],
        parentRenderElement: app!.appRenderElement,
    );
    ...
    await app!.updateChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), cols: 20),
            __WidgetClass__(key: GlobalKey('el-2'), cols: 20),
        ],
...
test('should clear attribute "cols" if updated value is null', () async {
    ...
    await app!.updateChildren(
        widgets: [
            __WidgetClass__(key: GlobalKey('el-1'), cols: null),
        ],
        updateType: UpdateType.setState,
        parentRenderElement: app!.appRenderElement,
    );
