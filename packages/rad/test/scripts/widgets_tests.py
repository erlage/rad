...
widget_specific_tests = {
    ...
    'InsertedText': ['widget_specific_html_widgets'],
    'KeyboardInput': ['widget_specific_html_widgets'],
    'Label': ['widget_specific_html_widgets'],
    'Legend': ['widget_specific_html_widgets'],
    'LineBreakOpportunity': ['widget_specific_html_widgets'],
    ...
    'RubyAnnotation': ['widget_specific_html_widgets'],
    ...
    'Summary': ['widget_specific_html_widgets'],
